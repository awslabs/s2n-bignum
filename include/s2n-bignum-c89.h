...
/* 128-bit value as two 64-bit halves (used for the AES-256-GCM Htable slots, */
/* each holding a twisted H power or a packed pair of Karatsuba mid values). */
/* Guarded so it does not clash with AWS-LC's own u128 if its modes/internal.h */
/* is also in scope. */

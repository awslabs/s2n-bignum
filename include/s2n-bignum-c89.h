...
/* SHA-512 block compression (no SHA-NI or SIMD) */
/* Inputs state[8], data[64*num_blocks]; output state[8] */
extern void sha512_compress(uint64_t state[8],const uint8_t *data,size_t num_blocks);

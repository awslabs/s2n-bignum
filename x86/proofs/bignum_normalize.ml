...
let bignum_normalize_cmc =
  define_assert_from_elf "bignum_normalize_cmc" "x86/generic/bignum_normalize.o"
[
...
let bignum_normalize_mc = define_trimmed "bignum_normalize_mc" bignum_normalize_cmc;;
...
let windows_bignum_normalize_cmc = define_from_elf
   "windows_bignum_normalize_cmc" "x86/generic/bignum_normalize.obj";;

let windows_bignum_normalize_mc = define_trimmed "windows_bignum_normalize_mc" windows_bignum_normalize_cmc;;

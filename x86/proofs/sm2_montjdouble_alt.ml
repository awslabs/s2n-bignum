...
let sm2_montjdouble_alt_cmc = define_assert_from_elf
  "sm2_montjdouble_alt_cmc" "x86/sm2/sm2_montjdouble_alt.o"
[
...
let sm2_montjdouble_alt_mc = define_trimmed "sm2_montjdouble_alt_mc" sm2_montjdouble_alt_cmc;;
...
let windows_sm2_montjdouble_alt_cmc = define_from_elf "windows_sm2_montjdouble_alt_cmc"
      "x86/sm2/sm2_montjdouble_alt.obj";;

let windows_sm2_montjdouble_alt_mc = define_trimmed "windows_sm2_montjdouble_alt_mc" windows_sm2_montjdouble_alt_cmc;;

let WINDOWS_SM2_MONTJDOUBLE_ALT_SUBROUTINE_CORRECT = time prove
 (`!p3 p1 t1 pc stackpointer returnaddress.
        ALL (nonoverlapping (word_sub stackpointer (word 248),248))
            [(word pc,LENGTH windows_sm2_montjdouble_alt_mc); (p1,96)] /\
        ALL (nonoverlapping (p3,96))
            [(word pc,LENGTH windows_sm2_montjdouble_alt_mc); (word_sub stackpointer (word 248),256)]
        ==> ensures x86

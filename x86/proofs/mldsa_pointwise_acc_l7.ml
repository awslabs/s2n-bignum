...
let MLDSA_POINTWISE_ACC_L7_NOIBT_SUBROUTINE_SAFE = time prove
 (`exists f_events.
       forall e c a b consts pc stackpointer returnaddress.
          ...
          nonoverlapping (c, 1024) (consts, 64) /\ nonoverlapping (a, 7168) (b, 7168) /\
          nonoverlapping (a, 7168) (consts, 64) /\ nonoverlapping (b, 7168) (consts, 64) /\
          nonoverlapping (stackpointer, 8) (c, 1024) /\
          nonoverlapping (stackpointer, 8) (a, 7168) /\
          nonoverlapping (stackpointer, 8) (b, 7168) /\
          nonoverlapping (stackpointer, 8) (consts, 64)
...
let MLDSA_POINTWISE_ACC_L7_NOIBT_WINDOWS_SUBROUTINE_SAFE = prove
...
let MLDSA_POINTWISE_ACC_L7_WINDOWS_SUBROUTINE_SAFE = prove
 (`exists f_events. forall e c a b consts pc stackpointer returnaddress.
        aligned 32 c /\ aligned 32 a /\ aligned 32 b /\ aligned 32 consts /\
        nonoverlapping (word pc, LENGTH mldsa_pointwise_acc_l7_windows_mc) (c, 1024) /\
        nonoverlapping (word pc, LENGTH mldsa_pointwise_acc_l7_windows_mc) (a, 7168) /\
        ...
        ==> ensures x86
              ...
              (MAYCHANGE [RSP] ,,
               ...
               MAYCHANGE [memory :> bytes(c, 1024)])`,
  MATCH_ACCEPT_TAC(ADD_IBT_RULE
    MLDSA_POINTWISE_ACC_L7_NOIBT_WINDOWS_SUBROUTINE_SAFE));;

...
[[0x48; 0x0f; 0xb7; 0xc2];  (* MOVZX (% rax) (% dx) *)
 ...
 [0xc5; 0xf1; 0x6f; 0xd3]; (* VMOVDQA xmm2, xmm3 *)
 [0xc5; 0xe9; 0x6f; 0xdc]; (* VMOVDQA xmm3, xmm4 *)
 [0xc5; 0xf9; 0x7f; 0xd1]; (* VMOVDQA xmm1, xmm2 *)
 [0xc5; 0xf1; 0x7f; 0xda]; (* VMOVDQA xmm2, xmm3 *)
 [0xc5; 0xfd; 0x6f; 0xca]; (* VMOVDQA ymm1, ymm2 *)
 [0xc5; 0xf5; 0x6f; 0xd3]; (* VMOVDQA ymm2, ymm3 *)
 [0xc5; 0xed; 0x6f; 0xdc]; (* VMOVDQA ymm3, ymm4 *)
 [0xc5; 0xfd; 0x7f; 0xd1]; (* VMOVDQA ymm1, ymm2 *)
 [0xc5; 0xf5; 0x7f; 0xda]; (* VMOVDQA ymm2, ymm3 *)

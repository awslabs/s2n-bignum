...
[[0x48; 0x0f; 0xb7; 0xc2];  (* MOVZX (% rax) (% dx) *)
 ...
 [0xc4; 0xe3; 0x65; 0x46; 0xed; 0x88]; (* VPERM2I128 ymm5, ymm3, ymm5, 0x88 (zero both lanes) *)
  ...
  [0xc4; 0xe3; 0x41; 0x22; 0xf8; 03];   (* VPINSRD xmm7, xmm7, eax, 0x3  *)
  [0xc4; 0xe3; 0xf9; 0x22; 0xc0; 91];   (* VPINSRQ xmm0, xmm0, rax, 0x91 *)
  [0xc4; 0x63; 0x39; 0x22; 0xc1; 17];   (* VPINSRD xmm8, xmm8, ecx, 0x17 *)
  [0xc4; 0x63; 0xb1; 0x22; 0xca; 76];   (* VPINSRQ xmm9, xmm9, rdx, 0x76 *)
  [0xc4; 0xc3; 0x69; 0x22; 0xd0; 19];   (* VPINSRD xmm2, xmm2, r8d, 0x19 *)
  [0xc4; 0xc3; 0xe1; 0x22; 0xdf; ff];   (* VPINSRQ xmm3, xmm3, r15, 0xff *)
  [0xc4; 0xe3; 0x79; 0x16; 0xf8; 03];   (* VPEXTRD eax, xmm7, 0x3  *)
  [0xc4; 0xe3; 0xf9; 0x16; 0xc0; 91];   (* VPEXTRQ rax, xmm0, 0x91 *)
  [0xc4; 0x63; 0x79; 0x16; 0xc1; 17];   (* VPEXTRD ecx, xmm8, 0x17 *)
  [0xc4; 0x63; 0xf9; 0x16; 0xca; 76];   (* VPEXTRQ rdx, xmm9, 0x76 *)
  [0xc4; 0xc3; 0x79; 0x16; 0xd0; 19];   (* VPEXTRD r8d, xmm2, 0x19 *)
  [0xc4; 0xc3; 0xf9; 0x16; 0xdf; ff];   (* VPEXTRQ r15, xmm3, 0xff *)

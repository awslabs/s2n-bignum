...
[[0x48; 0x0f; 0xb7; 0xc2];  (* MOVZX (% rax) (% dx) *)
 ...
 [0xc5; 0xfa; 0x6f; 0xca]; (* VMOVDQU xmm1, xmm2 *)
 [0xc5; 0xfa; 0x6f; 0xd3]; (* VMOVDQU xmm2, xmm3 *)
 [0xc5; 0xfa; 0x6f; 0xdc]; (* VMOVDQU xmm3, xmm4 *)
 [0xc5; 0xfa; 0x7f; 0xd1]; (* VMOVDQU xmm1, xmm2 *)
 [0xc5; 0xfa; 0x7f; 0xda]; (* VMOVDQU xmm2, xmm3 *)
 [0xc5; 0xfe; 0x6f; 0xca]; (* VMOVDQU ymm1, ymm2 *)
 [0xc5; 0xfe; 0x6f; 0xd3]; (* VMOVDQU ymm2, ymm3 *)
 [0xc5; 0xfe; 0x6f; 0xdc]; (* VMOVDQU ymm3, ymm4 *)
 [0xc5; 0xfe; 0x7f; 0xd1]; (* VMOVDQU ymm1, ymm2 *)
 [0xc5; 0xfe; 0x7f; 0xda]; (* VMOVDQU ymm2, ymm3 *)
 [0xc4; 0x41; 0x7a; 0x6f; 0xc1]; (* VMOVDQU xmm8, xmm9 *)
 [0xc4; 0x41; 0x7e; 0x6f; 0xca]; (* VMOVDQU ymm8, ymm10 *)

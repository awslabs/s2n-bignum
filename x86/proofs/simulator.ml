...
[[0x48; 0x0f; 0xb7; 0xc2];  (* MOVZX (% rax) (% dx) *)
 ...
 [0xc5; 0xa9; 0x71; 0xe1; 0x03]; (* VPSRAW (%_% xmm10) (%_% xmm1) (Imm8 (word 3)) *)
 [0xc5; 0xc5; 0x71; 0xe0; 0x08]; (* VPSRAW (%_% ymm7) (%_% ymm0) (Imm8 (word 8)) *)
 [0xc4; 0xc1; 0x71; 0x71; 0xe4; 0x03]; (* VPSRAW (%_% xmm1) (%_% xmm12) (Imm8 (word 3)) *)
 [0xc4; 0xc1; 0x2d; 0x71; 0xe4; 0x03]; (* VPSRAW (%_% ymm10) (%_% ymm12) (Imm8 (word 3)) *)
 [0xc5; 0xf1; 0x71; 0xe2; 0x08]; (* VPSRAW (%_% xmm1) (%_% xmm2) (Imm8 (word 8)) *)
 [0xc5; 0xf5; 0x71; 0xe2; 0x08]; (* VPSRAW (%_% ymm1) (%_% ymm2) (Imm8 (word 8)) *)
 [0xc5; 0xe9; 0x71; 0xe2; 0x00]; (* VPSRAW (%_% xmm2) (%_% xmm2) (Imm8 (word 0)) *)
 [0xc5; 0xed; 0x71; 0xe2; 0x00]; (* VPSRAW (%_% ymm2) (%_% ymm2) (Imm8 (word 0)) *)
 [0xc4; 0xc1; 0x61; 0x71; 0xe7; 0x01]; (* VPSRAW (%_% xmm3) (%_% xmm15) (Imm8 (word 1)) *)
 [0xc4; 0xc1; 0x5d; 0x71; 0xe6; 0x01]; (* VPSRAW (%_% ymm4) (%_% ymm14) (Imm8 (word 1)) *)
 [0xc4; 0xc1; 0x51; 0x71; 0xe5; 0x0f]; (* VPSRAW (%_% xmm5) (%_% xmm13) (Imm8 (word 15)) *)
 [0xc4; 0xc1; 0x4d; 0x71; 0xe4; 0x0f]; (* VPSRAW (%_% ymm6) (%_% ymm12) (Imm8 (word 15)) *)
 [0xc4; 0xc1; 0x41; 0x71; 0xe3; 0x10]; (* VPSRAW (%_% xmm7) (%_% xmm11) (Imm8 (word 16)) *)
 [0xc4; 0xc1; 0x3d; 0x71; 0xe2; 0x10]; (* VPSRAW (%_% ymm8) (%_% ymm10) (Imm8 (word 16)) *)
 [0xc4; 0xc1; 0x31; 0x71; 0xe1; 0x11]; (* VPSRAW (%_% xmm9) (%_% xmm9) (Imm8 (word 17)) *)
 [0xc4; 0xc1; 0x2d; 0x71; 0xe0; 0x11]; (* VPSRAW (%_% ymm10) (%_% ymm8) (Imm8 (word 17)) *)
 [0xc5; 0xa5; 0x71; 0xe7; 0x1f]; (* VPSRAW (%_% ymm11) (%_% ymm7) (Imm8 (word 31)) *)
 [0xc5; 0x9d; 0x71; 0xe6; 0x20]; (* VPSRAW (%_% ymm12) (%_% ymm6) (Imm8 (word 32)) *)
 [0xc5; 0x95; 0x71; 0xe5; 0x21]; (* VPSRAW (%_% ymm13) (%_% ymm5) (Imm8 (word 33)) *)
 [0xc5; 0x89; 0x71; 0xe4; 0xff]; (* VPSRAW (%_% xmm14) (%_% xmm4) (Imm8 (word 255)) *)
 [0xc5; 0x85; 0x71; 0xe3; 0xff]; (* VPSRAW (%_% ymm15) (%_% ymm3) (Imm8 (word 255)) *)
];;

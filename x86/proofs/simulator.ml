...
[[0x48; 0x0f; 0xb7; 0xc2];  (* MOVZX (% rax) (% dx) *)
 ...
 [0xc5; 0x79; 0xd5; 0xc9]; (* VPMULLW (%_% xmm1) (%_% xmm0) (%_% xmm9) *)
 [0xc4; 0xc1; 0x45; 0xe5; 0xdf]; (* VMULHW (%_% ymm15) (%_% ymm7) (%_% ymm3) *)
 [0xc4; 0xc1; 0x41; 0xe5; 0xdf]; (* VMULHW (%_% xmm15) (%_% xmm7) (%_% xmm3) *)

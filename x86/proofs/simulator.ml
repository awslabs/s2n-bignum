...
[[0x48; 0x0f; 0xb7; 0xc2];  (* MOVZX (% rax) (% dx) *)
 ...
 [0xc4; 0xe2; 0x7d; 0x58; 0xca]; (* VPBROADCASTD ymm1, xmm2 *)
 [0xc4; 0xe2; 0x7d; 0x58; 0xd3]; (* VPBROADCASTD ymm2, xmm3 *)
 [0xc4; 0xe2; 0x7d; 0x58; 0xdc]; (* VPBROADCASTD ymm3, xmm4 *)
 [0xc4; 0x62; 0x7d; 0x58; 0xc1]; (* VPBROADCASTD ymm8, xmm9 *)
 [0xc4; 0x62; 0x7d; 0x58; 0xd3]; (* VPBROADCASTD ymm10, xmm11 *)
 [0xc4; 0x62; 0x7d; 0x58; 0xe5]; (* VPBROADCASTD ymm12, xmm13 *)
 [0xc4; 0x62; 0x7d; 0x58; 0xf7]; (* VPBROADCASTD ymm14, xmm15 *)

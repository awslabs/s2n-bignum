...
[[0x48; 0x0f; 0xb7; 0xc2];  (* MOVZX (% rax) (% dx) *)
 ...
 [0xc4; 0xe2; 0x79; 0x58; 0xd3]; (* VPBROADCASTD xmm2, xmm3 *)
 [0xc4; 0xe2; 0x79; 0x58; 0xdc]; (* VPBROADCASTD xmm3, xmm4 *)
 [0xc4; 0xe2; 0x79; 0x58; 0xe5]; (* VPBROADCASTD xmm4, xmm5 *)
 [0xc4; 0xe2; 0x79; 0x58; 0xee]; (* VPBROADCASTD xmm5, xmm6 *)

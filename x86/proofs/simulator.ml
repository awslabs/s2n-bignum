...
[[0x48; 0x0f; 0xb7; 0xc2];  (* MOVZX (% rax) (% dx) *)
 ...
 [0xc5; 0xf5; 0xd4; 0xca]; (* VPADDQ ymm1, ymm1, ymm2 *)
 [0xc5; 0xed; 0xd4; 0xd3]; (* VPADDQ ymm2, ymm2, ymm3 *)
 [0xc5; 0xe5; 0xd4; 0xdc]; (* VPADDQ ymm3, ymm3, ymm4 *)
 [0xc5; 0xf9; 0xd4; 0xc1]; (* VPADDQ xmm0, xmm0, xmm1 *)
 [0xc5; 0xf1; 0xd4; 0xca]; (* VPADDQ xmm1, xmm1, xmm2 *)
 [0xc5; 0xe9; 0xd4; 0xd3]; (* VPADDQ xmm2, xmm2, xmm3 *)
 [0xc5; 0xe1; 0xd4; 0xdc]; (* VPADDQ xmm3, xmm3, xmm4 *)
 [0xc4; 0x41; 0x3d; 0xd4; 0xc1]; (* VPADDQ ymm8, ymm8, ymm9 *)
 [0xc4; 0x41; 0x2d; 0xd4; 0xd3]; (* VPADDQ ymm10, ymm10, ymm11 *)
 [0xc4; 0x41; 0x1d; 0xd4; 0xe5]; (* VPADDQ ymm12, ymm12, ymm13 *)
 [0xc4; 0x41; 0x0d; 0xd4; 0xf7]; (* VPADDQ ymm14, ymm14, ymm15 *)
 [0xc4; 0x41; 0x39; 0xd4; 0xc1]; (* VPADDQ xmm8, xmm8, xmm9 *)
 [0xc4; 0x41; 0x29; 0xd4; 0xd3]; (* VPADDQ xmm10, xmm10, xmm11 *)
 [0xc4; 0x41; 0x19; 0xd4; 0xe5]; (* VPADDQ xmm12, xmm12, xmm13 *)
 [0xc4; 0x41; 0x09; 0xd4; 0xf7]; (* VPADDQ xmm14, xmm14, xmm15 *)

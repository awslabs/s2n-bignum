...
[[0x48; 0x0f; 0xb7; 0xc2];  (* MOVZX (% rax) (% dx) *)
 ...
 [0xc5; 0xf9; 0x70; 0xc1; 0x4e]; (* VPSHUFD (%_% xmm0) (%_% xmm1) (Imm8 (word 78)) -- exact karat_mult_4 byte *)
 [0xc5; 0xf9; 0x70; 0xda; 0x4e]; (* VPSHUFD (%_% xmm3) (%_% xmm2) (Imm8 (word 78)) *)
 [0xc5; 0x79; 0x70; 0xe1; 0x4e]; (* VPSHUFD (%_% xmm12) (%_% xmm1) (Imm8 (word 78)) *)
 [0xc4; 0xc1; 0x79; 0x70; 0xea; 0x4e]; (* VPSHUFD (%_% xmm5) (%_% xmm10) (Imm8 (word 78)) *)
 [0xc5; 0xfd; 0x70; 0xc1; 0x1b]; (* VPSHUFD (%_% ymm0) (%_% ymm1) (Imm8 (word 27)) -- 256-bit lane form *)
 [0xc5; 0x7d; 0x70; 0xd2; 0xe4]; (* VPSHUFD (%_% ymm10) (%_% ymm2) (Imm8 (word 228)) *)
 ...
 [0x66; 0x0f; 0x3a; 0x44; 0xd1; 0x00]; (* PCLMULQDQ (%_% xmm2) (%_% xmm1) (Imm8 (word 0)) *)
 [0x66; 0x0f; 0x3a; 0x44; 0xd9; 0x11]; (* PCLMULQDQ (%_% xmm3) (%_% xmm1) (Imm8 (word 17)) *)
 [0x66; 0x0f; 0x3a; 0x44; 0xe1; 0x10]; (* PCLMULQDQ (%_% xmm4) (%_% xmm1) (Imm8 (word 16)) *)
 [0x66; 0x0f; 0x3a; 0x44; 0xc1; 0x01]; (* PCLMULQDQ (%_% xmm0) (%_% xmm1) (Imm8 (word 1)) *)
 [0x66; 0x45; 0x0f; 0x3a; 0x44; 0xd0; 0x11]; (* PCLMULQDQ (%_% xmm10) (%_% xmm8) (Imm8 (word 17)) *)
 [0x66; 0x0f; 0x73; 0xfc; 0x08]; (* PSLLDQ (%_% xmm4) (Imm8 (word 8)) *)
 [0x66; 0x0f; 0x73; 0xf9; 0x01]; (* PSLLDQ (%_% xmm1) (Imm8 (word 1)) *)
 [0x66; 0x41; 0x0f; 0x73; 0xfc; 0x0f]; (* PSLLDQ (%_% xmm12) (Imm8 (word 15)) *)
 [0x66; 0x0f; 0x73; 0xdd; 0x08]; (* PSRLDQ (%_% xmm5) (Imm8 (word 8)) *)
 [0x66; 0x0f; 0x73; 0xda; 0x04]; (* PSRLDQ (%_% xmm2) (Imm8 (word 4)) *)
 [0x66; 0x41; 0x0f; 0x73; 0xdd; 0x02]; (* PSRLDQ (%_% xmm13) (Imm8 (word 2)) *)
 ...
 [0xc5; 0xfd; 0x66; 0xc1]; (* VPCMPGTD ymm0, ymm0, ymm1 *)
 [0xc5; 0xf5; 0x66; 0xca]; (* VPCMPGTD ymm1, ymm1, ymm2 *)
 [0xc5; 0xed; 0x66; 0xd3]; (* VPCMPGTD ymm2, ymm2, ymm3 *)
 [0xc5; 0xe5; 0x66; 0xdc]; (* VPCMPGTD ymm3, ymm3, ymm4 *)
 [0xc5; 0xf9; 0x66; 0xc1]; (* VPCMPGTD xmm0, xmm0, xmm1 *)
 [0xc5; 0xf1; 0x66; 0xca]; (* VPCMPGTD xmm1, xmm1, xmm2 *)
 [0xc5; 0xe9; 0x66; 0xd3]; (* VPCMPGTD xmm2, xmm2, xmm3 *)
 [0xc5; 0xe1; 0x66; 0xdc]; (* VPCMPGTD xmm3, xmm3, xmm4 *)
 [0xc4; 0x41; 0x3d; 0x66; 0xc1]; (* VPCMPGTD ymm8, ymm8, ymm9 *)
 [0xc4; 0x41; 0x2d; 0x66; 0xd3]; (* VPCMPGTD ymm10, ymm10, ymm11 *)
 [0xc4; 0x41; 0x1d; 0x66; 0xe5]; (* VPCMPGTD ymm12, ymm12, ymm13 *)
 [0xc4; 0x41; 0x0d; 0x66; 0xf7]; (* VPCMPGTD ymm14, ymm14, ymm15 *)
 [0xc4; 0x41; 0x39; 0x66; 0xc1]; (* VPCMPGTD xmm8, xmm8, xmm9 *)
 [0xc4; 0x41; 0x29; 0x66; 0xd3]; (* VPCMPGTD xmm10, xmm10, xmm11 *)
 [0xc4; 0x41; 0x19; 0x66; 0xe5]; (* VPCMPGTD xmm12, xmm12, xmm13 *)
 [0xc4; 0x41; 0x09; 0x66; 0xf7]; (* VPCMPGTD xmm14, xmm14, xmm15 *)
 [0xc5; 0xfd; 0x65; 0xc1]; (* VPCMPGTW ymm0, ymm0, ymm1 *)
 [0xc5; 0xf5; 0x65; 0xca]; (* VPCMPGTW ymm1, ymm1, ymm2 *)
 [0xc5; 0xed; 0x65; 0xd3]; (* VPCMPGTW ymm2, ymm2, ymm3 *)
 [0xc5; 0xe5; 0x65; 0xdc]; (* VPCMPGTW ymm3, ymm3, ymm4 *)
 [0xc5; 0xf9; 0x65; 0xc1]; (* VPCMPGTW xmm0, xmm0, xmm1 *)
 [0xc5; 0xf1; 0x65; 0xca]; (* VPCMPGTW xmm1, xmm1, xmm2 *)
 [0xc5; 0xe9; 0x65; 0xd3]; (* VPCMPGTW xmm2, xmm2, xmm3 *)
 [0xc5; 0xe1; 0x65; 0xdc]; (* VPCMPGTW xmm3, xmm3, xmm4 *)
 [0xc4; 0x41; 0x3d; 0x65; 0xc1]; (* VPCMPGTW ymm8, ymm8, ymm9 *)
 [0xc4; 0x41; 0x2d; 0x65; 0xd3]; (* VPCMPGTW ymm10, ymm10, ymm11 *)
 [0xc4; 0x41; 0x1d; 0x65; 0xe5]; (* VPCMPGTW ymm12, ymm12, ymm13 *)
 [0xc4; 0x41; 0x0d; 0x65; 0xf7]; (* VPCMPGTW ymm14, ymm14, ymm15 *)
 [0xc4; 0x41; 0x39; 0x65; 0xc1]; (* VPCMPGTW xmm8, xmm8, xmm9 *)
 [0xc4; 0x41; 0x29; 0x65; 0xd3]; (* VPCMPGTW xmm10, xmm10, xmm11 *)
 [0xc4; 0x41; 0x19; 0x65; 0xe5]; (* VPCMPGTW xmm12, xmm12, xmm13 *)
 [0xc4; 0x41; 0x09; 0x65; 0xf7]; (* VPCMPGTW xmm14, xmm14, xmm15 *)
 [0xc5; 0xfd; 0x75; 0xc1]; (* VPCMPEQW ymm0, ymm0, ymm1 *)
 [0xc5; 0xf5; 0x75; 0xca]; (* VPCMPEQW ymm1, ymm1, ymm2 *)
 [0xc5; 0xed; 0x75; 0xd3]; (* VPCMPEQW ymm2, ymm2, ymm3 *)
 [0xc5; 0xe5; 0x75; 0xdc]; (* VPCMPEQW ymm3, ymm3, ymm4 *)
 [0xc5; 0xf9; 0x75; 0xc1]; (* VPCMPEQW xmm0, xmm0, xmm1 *)
 [0xc5; 0xf1; 0x75; 0xca]; (* VPCMPEQW xmm1, xmm1, xmm2 *)
 [0xc5; 0xe9; 0x75; 0xd3]; (* VPCMPEQW xmm2, xmm2, xmm3 *)
 [0xc5; 0xe1; 0x75; 0xdc]; (* VPCMPEQW xmm3, xmm3, xmm4 *)
 [0xc4; 0x41; 0x3d; 0x75; 0xc1]; (* VPCMPEQW ymm8, ymm8, ymm9 *)
 [0xc4; 0x41; 0x2d; 0x75; 0xd3]; (* VPCMPEQW ymm10, ymm10, ymm11 *)
 [0xc4; 0x41; 0x1d; 0x75; 0xe5]; (* VPCMPEQW ymm12, ymm12, ymm13 *)
 [0xc4; 0x41; 0x0d; 0x75; 0xf7]; (* VPCMPEQW ymm14, ymm14, ymm15 *)
 [0xc4; 0x41; 0x39; 0x75; 0xc1]; (* VPCMPEQW xmm8, xmm8, xmm9 *)
 [0xc4; 0x41; 0x29; 0x75; 0xd3]; (* VPCMPEQW xmm10, xmm10, xmm11 *)
 [0xc4; 0x41; 0x19; 0x75; 0xe5]; (* VPCMPEQW xmm12, xmm12, xmm13 *)
 [0xc4; 0x41; 0x09; 0x75; 0xf7]; (* VPCMPEQW xmm14, xmm14, xmm15 *)
 ...
 [0xc5; 0xfd; 0xe4; 0xc1]; (* VPMULHUW (%_% ymm0) (%_% ymm0) (%_% ymm1) *)
 [0xc5; 0xf9; 0xe4; 0xc1]; (* VPMULHUW (%_% xmm0) (%_% xmm0) (%_% xmm1) *)
 [0xc5; 0x45; 0xe4; 0xfb]; (* VPMULHUW (%_% ymm15) (%_% ymm7) (%_% ymm3) *)
 [0xc5; 0x41; 0xe4; 0xfb]; (* VPMULHUW (%_% xmm15) (%_% xmm7) (%_% xmm3) *)
 ...
 [0xc5; 0xfc; 0x50; 0xca]; (* vmovmskps ecx, ymm2 *)
 [0xc5; 0xfc; 0x50; 0xd3]; (* vmovmskps edx, ymm3 *)
 [0xc5; 0xfc; 0x50; 0xfc]; (* vmovmskps edi, ymm4 *)
 [0xc4; 0x41; 0x7c; 0x50; 0xc1]; (* vmovmskps r8d, ymm9 *)
 [0xc4; 0x41; 0x7c; 0x50; 0xd3]; (* vmovmskps r10d, ymm11 *)
 [0xc4; 0x41; 0x7c; 0x50; 0xe5]; (* vmovmskps r12d, ymm13 *)
 [0xc4; 0x41; 0x7c; 0x50; 0xf7]; (* vmovmskps r14d, ymm15 *)
 [0xc4; 0xe2; 0x7d; 0x31; 0xc1]; (* vpmovzxbd ymm0, xmm1 *)
 [0xc4; 0xe2; 0x7d; 0x31; 0xca]; (* vpmovzxbd ymm1, xmm2 *)
 [0xc4; 0xe2; 0x7d; 0x31; 0xd3]; (* vpmovzxbd ymm2, xmm3 *)
 [0xc4; 0xe2; 0x7d; 0x31; 0xdc]; (* vpmovzxbd ymm3, xmm4 *)
 [0xc4; 0x42; 0x7d; 0x31; 0xc1]; (* vpmovzxbd ymm8, xmm9 *)
 [0xc4; 0x42; 0x7d; 0x31; 0xd3]; (* vpmovzxbd ymm10, xmm11 *)
 [0xc4; 0x42; 0x7d; 0x31; 0xe5]; (* vpmovzxbd ymm12, xmm13 *)
 [0xc4; 0x42; 0x7d; 0x31; 0xf7]; (* vpmovzxbd ymm14, xmm15 *)
 [0xc4; 0xe2; 0x79; 0x31; 0xc1]; (* vpmovzxbd xmm0, xmm1 *)
 [0xc4; 0xe2; 0x79; 0x31; 0xca]; (* vpmovzxbd xmm1, xmm2 *)
 [0xc4; 0x42; 0x79; 0x31; 0xc1]; (* vpmovzxbd xmm8, xmm9 *)
 [0xc4; 0x42; 0x79; 0x31; 0xf7]; (* vpmovzxbd xmm14, xmm15 *)
 [0xc5; 0xf8; 0x77]; (* vzeroupper *)
 [0xc5; 0xfd; 0xd7; 0xc1]; (* vpmovmskb eax, ymm1 *)
 [0xc5; 0xfd; 0xd7; 0xca]; (* vpmovmskb ecx, ymm2 *)
 [0xc5; 0xfd; 0xd7; 0xd3]; (* vpmovmskb edx, ymm3 *)
 [0xc5; 0xfd; 0xd7; 0xfc]; (* vpmovmskb edi, ymm4 *)
 [0xc4; 0x41; 0x7d; 0xd7; 0xc1]; (* vpmovmskb r8d, ymm9 *)
 [0xc4; 0x41; 0x7d; 0xd7; 0xd3]; (* vpmovmskb r10d, ymm11 *)
 [0xc4; 0x41; 0x7d; 0xd7; 0xe5]; (* vpmovmskb r12d, ymm13 *)
 [0xc4; 0x41; 0x7d; 0xd7; 0xf7]; (* vpmovmskb r14d, ymm15 *)
 [0xc4; 0xe2; 0x7d; 0x21; 0xc1]; (* vpmovsxbd ymm0, xmm1 *)
 [0xc4; 0xe2; 0x7d; 0x21; 0xca]; (* vpmovsxbd ymm1, xmm2 *)
 [0xc4; 0xe2; 0x7d; 0x21; 0xd3]; (* vpmovsxbd ymm2, xmm3 *)
 [0xc4; 0xe2; 0x7d; 0x21; 0xdc]; (* vpmovsxbd ymm3, xmm4 *)
 [0xc4; 0x42; 0x7d; 0x21; 0xc1]; (* vpmovsxbd ymm8, xmm9 *)
 [0xc4; 0x42; 0x7d; 0x21; 0xd3]; (* vpmovsxbd ymm10, xmm11 *)
 [0xc4; 0x42; 0x7d; 0x21; 0xe5]; (* vpmovsxbd ymm12, xmm13 *)
 [0xc4; 0x42; 0x7d; 0x21; 0xf7]; (* vpmovsxbd ymm14, xmm15 *)
 [0xc4; 0xe2; 0x79; 0x21; 0xc1]; (* vpmovsxbd xmm0, xmm1 *)
 [0xc4; 0xe2; 0x79; 0x21; 0xca]; (* vpmovsxbd xmm1, xmm2 *)
 [0xc4; 0x42; 0x79; 0x21; 0xc1]; (* vpmovsxbd xmm8, xmm9 *)
 [0xc4; 0x42; 0x79; 0x21; 0xf7]; (* vpmovsxbd xmm14, xmm15 *)
 [0xc4; 0xe2; 0x7d; 0x30; 0xc1]; (* vpmovzxbw ymm0, xmm1 *)
 [0xc4; 0xe2; 0x7d; 0x30; 0xca]; (* vpmovzxbw ymm1, xmm2 *)
 [0xc4; 0xe2; 0x7d; 0x30; 0xd3]; (* vpmovzxbw ymm2, xmm3 *)
 [0xc4; 0xe2; 0x7d; 0x30; 0xdc]; (* vpmovzxbw ymm3, xmm4 *)
 [0xc4; 0x42; 0x7d; 0x30; 0xc1]; (* vpmovzxbw ymm8, xmm9 *)
 [0xc4; 0x42; 0x7d; 0x30; 0xd3]; (* vpmovzxbw ymm10, xmm11 *)
 [0xc4; 0x42; 0x7d; 0x30; 0xe5]; (* vpmovzxbw ymm12, xmm13 *)
 [0xc4; 0x42; 0x7d; 0x30; 0xf7]; (* vpmovzxbw ymm14, xmm15 *)
 [0xc4; 0xe2; 0x79; 0x30; 0xc1]; (* vpmovzxbw xmm0, xmm1 *)
 [0xc4; 0xe2; 0x79; 0x30; 0xca]; (* vpmovzxbw xmm1, xmm2 *)
 [0xc4; 0x42; 0x79; 0x30; 0xc1]; (* vpmovzxbw xmm8, xmm9 *)
 [0xc4; 0x42; 0x79; 0x30; 0xf7]; (* vpmovzxbw xmm14, xmm15 *)
 [0xc5; 0x81; 0xf8; 0xf6]; (* vpsubb xmm6, xmm15, xmm6 *)
 [0xc5; 0x85; 0xf8; 0xf6]; (* vpsubb ymm6, ymm15, ymm6 *)
 [0xc5; 0xc1; 0xf8; 0xc9]; (* vpsubb xmm1, xmm7, xmm1 *)
 [0xc5; 0xc5; 0xf8; 0xc9]; (* vpsubb ymm1, ymm7, ymm1 *)
 [0xc4; 0x41; 0x29; 0xf8; 0xd3]; (* vpsubb xmm10, xmm10, xmm11 *)
 [0xc4; 0x41; 0x2d; 0xf8; 0xd3]; (* vpsubb ymm10, ymm10, ymm11 *)
 [0xc4; 0x41; 0x09; 0xf8; 0xf7]; (* vpsubb xmm14, xmm14, xmm15 *)
 [0xc4; 0x41; 0x0d; 0xf8; 0xf7]; (* vpsubb ymm14, ymm14, ymm15 *)
 [0xc4; 0xe2; 0x7d; 0x1e; 0xc1]; (* vpabsd ymm0, ymm1 *)
 [0xc4; 0xe2; 0x7d; 0x1e; 0xca]; (* vpabsd ymm1, ymm2 *)
 [0xc4; 0xe2; 0x7d; 0x1e; 0xd3]; (* vpabsd ymm2, ymm3 *)
 [0xc4; 0xe2; 0x7d; 0x1e; 0xdc]; (* vpabsd ymm3, ymm4 *)
 ...
 [0xc4; 0xe2; 0x79; 0x1e; 0xc1]; (* vpabsd xmm0, xmm1 *)
 [0xc4; 0xe2; 0x79; 0x1e; 0xca]; (* vpabsd xmm1, xmm2 *)
 [0xc4; 0x42; 0x79; 0x1e; 0xc1]; (* vpabsd xmm8, xmm9 *)
 [0xc4; 0x42; 0x79; 0x1e; 0xf7]; (* vpabsd xmm14, xmm15 *)
 [0xc4; 0xe2; 0x7d; 0x17; 0xc9]; (* vptest ymm1, ymm1 *)
 [0xc4; 0xe2; 0x7d; 0x17; 0xd2]; (* vptest ymm2, ymm2 *)
 [0xc4; 0xe2; 0x7d; 0x17; 0xdb]; (* vptest ymm3, ymm3 *)
 [0xc4; 0xe2; 0x7d; 0x17; 0xe4]; (* vptest ymm4, ymm4 *)
 [0xc4; 0x42; 0x7d; 0x17; 0xc1]; (* vptest ymm8, ymm9 *)
 [0xc4; 0x42; 0x7d; 0x17; 0xd3]; (* vptest ymm10, ymm11 *)
 [0xc4; 0x42; 0x7d; 0x17; 0xe5]; (* vptest ymm12, ymm13 *)
 [0xc4; 0x42; 0x7d; 0x17; 0xf7]; (* vptest ymm14, ymm15 *)
 [0xc4; 0xe2; 0x7d; 0x17; 0xc1]; (* vptest ymm0, ymm1 *)
 [0xc4; 0xe2; 0x7d; 0x17; 0xca]; (* vptest ymm1, ymm2 *)
 [0xc4; 0xe2; 0x79; 0x17; 0xc9]; (* vptest xmm1, xmm1 *)
...
[
  ...
  [0xc4; 0xe2; 0x7d; 0x21; 0x04; 0x24]; (* VPMOVSXBD (%_% ymm0) (Memop Quadword (%% (rsp,0))) *)
  [0xc4; 0xe2; 0x79; 0x21; 0x04; 0x24]; (* VPMOVSXBD (%_% xmm0) (Memop Doubleword (%% (rsp,0))) *)
  [0xc4; 0xe2; 0x7d; 0x31; 0x04; 0x24]; (* VPMOVZXBD (%_% ymm0) (Memop Quadword (%% (rsp,0))) *)
  [0xc4; 0xe2; 0x79; 0x31; 0x04; 0x24]; (* VPMOVZXBD (%_% xmm0) (Memop Doubleword (%% (rsp,0))) *)
  [0xc4; 0xe2; 0x7d; 0x30; 0x04; 0x24]; (* VPMOVZXBW (%_% ymm0) (Memop Word128 (%% (rsp,0))) *)

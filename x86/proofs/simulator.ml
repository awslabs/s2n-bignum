...
[[0x48; 0x0f; 0xb7; 0xc2];  (* MOVZX (% rax) (% dx) *)
 ...
 [0xc4; 0xe2; 0x7d; 0x7c; 0xc1]; (* VPBROADCASTQ ymm0, xmm1 *)
 [0xc4; 0xe2; 0x7d; 0x7c; 0xca]; (* VPBROADCASTQ ymm1, xmm2 *)
 [0xc4; 0xe2; 0x7d; 0x7c; 0xd3]; (* VPBROADCASTQ ymm2, xmm3 *)
 [0xc4; 0xe2; 0x7d; 0x7c; 0xdc]; (* VPBROADCASTQ ymm3, xmm4 *)
 [0xc4; 0x62; 0x7d; 0x7c; 0xc1]; (* VPBROADCASTQ ymm8, xmm9 *)
 [0xc4; 0x62; 0x7d; 0x7c; 0xd3]; (* VPBROADCASTQ ymm10, xmm11 *)
 [0xc4; 0x62; 0x7d; 0x7c; 0xe5]; (* VPBROADCASTQ ymm12, xmm13 *)
 [0xc4; 0x62; 0x7d; 0x7c; 0xf7]; (* VPBROADCASTQ ymm14, xmm15 *)
 [0xc4; 0xe2; 0x79; 0x7c; 0xc1]; (* VPBROADCASTQ xmm0, xmm1 *)
 [0xc4; 0xe2; 0x79; 0x7c; 0xca]; (* VPBROADCASTQ xmm1, xmm2 *)
 [0xc4; 0xe2; 0x79; 0x7c; 0xd3]; (* VPBROADCASTQ xmm2, xmm3 *)
 [0xc4; 0xe2; 0x79; 0x7c; 0xdc]; (* VPBROADCASTQ xmm3, xmm4 *)
 [0xc4; 0x62; 0x79; 0x7c; 0xc1]; (* VPBROADCASTQ xmm8, xmm9 *)
 [0xc4; 0x62; 0x79; 0x7c; 0xd3]; (* VPBROADCASTQ xmm10, xmm11 *)
 [0xc4; 0x62; 0x79; 0x7c; 0xe5]; (* VPBROADCASTQ xmm12, xmm13 *)
 [0xc4; 0x62; 0x79; 0x7c; 0xf7]; (* VPBROADCASTQ xmm14, xmm15 *)

...
[[0x48; 0x0f; 0xb7; 0xc2];  (* MOVZX (% rax) (% dx) *)
 ...
 [0xc5; 0xfd; 0x40; 0xc1]; (* VPMULLD ymm0, ymm0, ymm1 *)
 [0xc5; 0xf5; 0x40; 0xca]; (* VPMULLD ymm1, ymm1, ymm2 *)
 [0xc5; 0xed; 0x40; 0xd3]; (* VPMULLD ymm2, ymm2, ymm3 *)
 [0xc5; 0xe5; 0x40; 0xdc]; (* VPMULLD ymm3, ymm3, ymm4 *)
 [0xc5; 0x79; 0x40; 0xc1]; (* VPMULLD xmm0, xmm0, xmm1 *)
 [0xc5; 0x71; 0x40; 0xca]; (* VPMULLD xmm1, xmm1, xmm2 *)
 [0xc5; 0x69; 0x40; 0xd3]; (* VPMULLD xmm2, xmm2, xmm3 *)
 [0xc5; 0x61; 0x40; 0xdc]; (* VPMULLD xmm3, xmm3, xmm4 *)
 [0xc4; 0x41; 0x7d; 0x40; 0xc1]; (* VPMULLD ymm8, ymm8, ymm9 *)
 [0xc4; 0x41; 0x6d; 0x40; 0xd3]; (* VPMULLD ymm10, ymm10, ymm11 *)
 [0xc4; 0x41; 0x5d; 0x40; 0xe5]; (* VPMULLD ymm12, ymm12, ymm13 *)
 [0xc4; 0x41; 0x4d; 0x40; 0xf7]; (* VPMULLD ymm14, ymm14, ymm15 *)
 [0xc4; 0x41; 0x79; 0x40; 0xc1]; (* VPMULLD xmm8, xmm8, xmm9 *)
 [0xc4; 0x41; 0x69; 0x40; 0xd3]; (* VPMULLD xmm10, xmm10, xmm11 *)
 [0xc4; 0x41; 0x59; 0x40; 0xe5]; (* VPMULLD xmm12, xmm12, xmm13 *)
 [0xc4; 0x41; 0x49; 0x40; 0xf7]; (* VPMULLD xmm14, xmm14, xmm15 *)

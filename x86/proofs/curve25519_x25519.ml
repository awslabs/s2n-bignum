...
let CURVE25519_X25519_IBT_SUBROUTINE_CORRECT = time prove
 (`!res scalar n point X pc stackpointer returnaddress.
    ALL (nonoverlapping (word_sub stackpointer (word 464),464))
        [(word pc,LENGTH curve25519_x25519_cmc); (point,32); (scalar,32)] /\
    nonoverlapping (res,32) (word pc,LENGTH curve25519_x25519_cmc) /\
    nonoverlapping (res,32) (word_sub stackpointer (word 464),472)
    ==> ensures x86
         (\s. bytes_loaded s (word pc) curve25519_x25519_cmc /\
              read RIP s = word pc /\
              read RSP s = stackpointer /\
              read (memory :> bytes64 stackpointer) s = returnaddress /\
              C_ARGUMENTS [res; scalar; point] s /\
         ...
         (MAYCHANGE [RSP] ,, MAYCHANGE_REGS_AND_FLAGS_PERMITTED_BY_ABI ,,
          MAYCHANGE [memory :> bytes(res,32);
                     memory :> bytes(word_sub stackpointer (word 464),464)])`,
  MATCH_ACCEPT_TAC(ADD_IBT_RULE CURVE25519_X25519_SUBROUTINE_CORRECT));;
...
let CURVE25519_X25519_BYTE_IBT_SUBROUTINE_CORRECT = prove
 (`!res scalar n point X pc stackpointer returnaddress.
    ALL (nonoverlapping (word_sub stackpointer (word 464),464))
        [(word pc,LENGTH curve25519_x25519_cmc); (point,32); (scalar,32)] /\
    nonoverlapping (res,32) (word pc,LENGTH curve25519_x25519_cmc) /\
    ...
    ==> ensures x86
         ...
         (MAYCHANGE [RSP] ,, MAYCHANGE_REGS_AND_FLAGS_PERMITTED_BY_ABI ,,
          MAYCHANGE [memory :> bytes(res,32);
                     memory :> bytes(word_sub stackpointer (word 464),464)])`,
  MATCH_ACCEPT_TAC(ADD_IBT_RULE CURVE25519_X25519_BYTE_SUBROUTINE_CORRECT));;
...
let WINDOWS_CURVE25519_X25519_IBT_SUBROUTINE_CORRECT = time prove
 (`!res scalar n point X pc stackpointer returnaddress.
    ALL (nonoverlapping (word_sub stackpointer (word 480),480))
        [(word pc,LENGTH windows_curve25519_x25519_cmc); (point,32); (scalar,32)] /\
    nonoverlapping (res,32) (word pc,LENGTH windows_curve25519_x25519_cmc) /\
    nonoverlapping (res,32) (word_sub stackpointer (word 480),488)
    ==> ensures x86
         (\s. bytes_loaded s (word pc) windows_curve25519_x25519_cmc /\
              read RIP s = word pc /\
              read RSP s = stackpointer /\
              read (memory :> bytes64 stackpointer) s = returnaddress /\
              WINDOWS_C_ARGUMENTS [res; scalar; point] s /\
         ...
         (MAYCHANGE [RSP] ,, WINDOWS_MAYCHANGE_REGS_AND_FLAGS_PERMITTED_BY_ABI ,,
          MAYCHANGE [memory :> bytes(res,32);
                     memory :> bytes(word_sub stackpointer (word 480),480)])`,
  MATCH_ACCEPT_TAC(ADD_IBT_RULE WINDOWS_CURVE25519_X25519_SUBROUTINE_CORRECT));;
...
let WINDOWS_CURVE25519_X25519_BYTE_IBT_SUBROUTINE_CORRECT = prove
 (`!res scalar n point X pc stackpointer returnaddress.
    ALL (nonoverlapping (word_sub stackpointer (word 480),480))
        [(word pc,LENGTH windows_curve25519_x25519_cmc); (point,32); (scalar,32)] /\
    nonoverlapping (res,32) (word pc,LENGTH windows_curve25519_x25519_cmc) /\
    ...
    ==> ensures x86
         ...
         (MAYCHANGE [RSP] ,, WINDOWS_MAYCHANGE_REGS_AND_FLAGS_PERMITTED_BY_ABI ,,
          MAYCHANGE [memory :> bytes(res,32);
                     memory :> bytes(word_sub stackpointer (word 480),480)])`,
  MATCH_ACCEPT_TAC(ADD_IBT_RULE WINDOWS_CURVE25519_X25519_BYTE_SUBROUTINE_CORRECT));;

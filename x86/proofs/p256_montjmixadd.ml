...
let p256_montjmixadd_cmc = define_assert_from_elf
  "p256_montjmixadd_cmc" "x86/p256/p256_montjmixadd.o"
[
...
let p256_montjmixadd_mc = define_trimmed "p256_montjmixadd_mc" p256_montjmixadd_cmc;;
...
let windows_p256_montjmixadd_cmc = define_from_elf "windows_p256_montjmixadd_cmc"
      "x86/p256/p256_montjmixadd.obj";;

let windows_p256_montjmixadd_mc = define_trimmed "windows_p256_montjmixadd_mc" windows_p256_montjmixadd_cmc;;

let WINDOWS_P256_MONTJMIXADD_SUBROUTINE_CORRECT = time prove
 (`!p3 p1 t1 p2 t2 pc stackpointer returnaddress.
        ALL (nonoverlapping (word_sub stackpointer (word 256),256))
            [(word pc,LENGTH windows_p256_montjmixadd_mc); (p1,96); (p2,64)] /\
        ALL (nonoverlapping (p3,96))
            [(word pc,LENGTH windows_p256_montjmixadd_mc); (word_sub stackpointer (word 256),264)]
        ==> ensures x86

  ...
  REMOVE_THEN assump_name (fun safety_th ->
    ...
    ARM_SUBROUTINE_SIM_TAC ~is_safety_thm:true
        (p384_montjscalarmul_mc,P384_MONTJSCALARMUL_EXEC,
          0x7688,p384_montjdouble_mc,th)
        [`e:(uarch_event)list`; `read X0 s`; `read X1 s`;
        `pc + 0x7688`; `read SP s`; `read X30 s`] n THENL [
      EXISTS_E2_TAC(ref
        [`scalar:int64`;`point:int64`;`res:int64`;`pc:num`;
         `stackpointer:int64`;
         (* inside the loop... *)
...
let P384_MONTJSCALARMUL_SAFE = time prove
 (`exists f_events.
       forall e res scalar point pc stackpointer.
           aligned 16 stackpointer /\
           ALL (nonoverlapping (stackpointer,3104))
           [word pc,LENGTH p384_montjscalarmul_mc; res,144; scalar,48;
            point,144] /\
           nonoverlapping (res,144) (word pc,LENGTH p384_montjscalarmul_mc)
           ==> ensures arm
               (\s.
                    aligned_bytes_loaded s (word pc) p384_montjscalarmul_mc /\
               ...
               (\s.
                    ...
                    (exists e2.
                         ...
                         [scalar,48; point,144; res,144; stackpointer,3104]
                         [res,144; stackpointer,3104]))
               (MAYCHANGE_REGS_AND_FLAGS_PERMITTED_BY_ABI ,,
                MAYCHANGE [X19; X20; X21; X22; X23; X24; X25; X30] ,,
                MAYCHANGE
  ...
  ASSUME_CALLEE_SAFETY_TAILED_TAC P384_MONTJADD_SUBROUTINE_SAFE
      "H_JADD_SAFE" THEN
  ASSUME_CALLEE_SAFETY_TAILED_TAC P384_MONTJDOUBLE_SUBROUTINE_SAFE
      "H_JDOUBLE_SAFE" THEN
  ...
  REPEAT CONJ_TAC THENL [
    ...
    ARM_STEPS_TAC P384_MONTJSCALARMUL_EXEC (1--52) THEN
    ...
    ARM_STEPS_TAC P384_MONTJSCALARMUL_EXEC (117--637) THEN
    ...
    ARM_STEPS_TAC P384_MONTJSCALARMUL_EXEC (1--18) THEN
    ENSURES_FINAL_STATE_TAC THEN ASM_REWRITE_TAC[] THEN
    DISCHARGE_SAFETY_PROPERTY_TAC
  ] THEN
  ...
  ARM_STEPS_TAC P384_MONTJSCALARMUL_EXEC (22--37) THEN
  ARM_STEPS_TAC P384_MONTJSCALARMUL_EXEC (38--520) THEN
  ARM_STEPS_TAC P384_MONTJSCALARMUL_EXEC (521--552) THEN
  ARM_STEPS_TAC P384_MONTJSCALARMUL_EXEC (553--556) THEN
  LOCAL_JADD_SAFETY_TAC "H_JADD_SAFE" 557 THEN
  ARM_STEPS_TAC P384_MONTJSCALARMUL_EXEC (558--558) THEN
             ...
             (\s. read PC s = returnaddress /\
                  (exists e2.
                         ...
                         [scalar,48; point,144; res,144;
                          word_sub stackpointer (word 3168),3168]
                         [res,144;
                          word_sub stackpointer (word 3168),3168]))
          (MAYCHANGE_REGS_AND_FLAGS_PERMITTED_BY_ABI ,,
           MAYCHANGE[memory :> bytes(res,144);
                  memory :> bytes(word_sub stackpointer (word 3168),3168)])`,
  ARM_ADD_RETURN_STACK_TAC P384_MONTJSCALARMUL_EXEC
    P384_MONTJSCALARMUL_SAFE
    `[X19; X20; X21; X22; X23; X24; X25; X30]` 3168 THEN
  DISCHARGE_SAFETY_PROPERTY_TAC);;

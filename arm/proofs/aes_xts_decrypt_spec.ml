...
let ciphertext = new_definition
  `ciphertext = [word 0xc3; word 0x0c; word 0xa8; word 0xf2
...
let plaintext = new_definition
  `plaintext = [word 0x0f; word 0x0e; word 0x0d; word 0x0c
...
(REWRITE_CONV [iv_tweak;KEY2] THENC XTS_INIT_TWEAK_CONV) `xts_init_tweak iv_tweak KEY2`;;
...
BYTES_TO_INT128_CONV `bytes_to_int128
    [word 0x0f; word 0x0e; word 0x0d; word 0x0c
   ; word 0x0b; word 0x0a; word 0x09; word 0x08
   ; word 0x07; word 0x06; word 0x05; word 0x04
   ; word 0x03; word 0x02; word 0x01; word 0x00]`;;
...
GF_128_MULT_BY_PRIMITIVE_CONV `GF_128_mult_by_primitive (word 0xffffffffffffffffffffffffffffffff)`;;
...
(REWRITE_CONV [iv_tweak;KEY1;KEY2;ciphertext] THENC AES256_XTS_DECRYPT_REC_CONV)
  `aes256_xts_decrypt_rec 0 0 ciphertext iv_tweak KEY1`;;
...
(REWRITE_CONV [ciphertext;iv_tweak;KEY1] THENC CIPHER_STEALING_CONV)
  `cipher_stealing ciphertext [(word 0x0)] 1 iv_tweak KEY1`;;
...
(REWRITE_CONV [ciphertext;iv_tweak;KEY1;KEY2] THENC AES256_XTS_DECRYPT_TAIL_CONV)
  `aes256_xts_decrypt_tail 0 0 ciphertext iv_tweak KEY1`;;

(REWRITE_CONV [iv_tweak;KEY1;KEY2] THENC AES256_XTS_DECRYPT_TAIL_CONV)
`aes256_xts_decrypt_tail 0 1
   [word 0xc3; word 0x0c; word 0xa8; word 0xf2
  ; word 0xed; word 0x57; word 0x30; word 0x7e
  ; word 0xdc; word 0x87; word 0xe5; word 0x44
  ; word 0x86; word 0x7a; word 0xc8; word 0x88; word 0x00]
  iv_tweak KEY1`;;
...
(REWRITE_CONV [perror] THENC AES256_XTS_DECRYPT_CONV)
  `aes256_xts_decrypt ciphertext 5 iv_tweak KEY1 KEY2 perror`;;

(REWRITE_CONV [ciphertext;iv_tweak;KEY1;KEY2;perror] THENC AES256_XTS_DECRYPT_CONV)
  `aes256_xts_decrypt ciphertext 16 iv_tweak KEY1 KEY2 perror`;;
...
time (REWRITE_CONV [iv_tweak;KEY1;KEY2;perror] THENC AES256_XTS_DECRYPT_CONV)
  `aes256_xts_decrypt
    [ word 0xc3; word 0x0c; word 0xa8; word 0xf2;
      ...
      word 0xdc; word 0x87; word 0xe5; word 0x44;
      word 0x86; word 0x7a; word 0xc8; word 0x88 ]
    16 iv_tweak KEY1 KEY2 perror`;;

(* 1 block + 6 bytes : 121 seconds *)
time (REWRITE_CONV [iv_tweak;KEY1;KEY2;perror] THENC AES256_XTS_DECRYPT_CONV)
  `aes256_xts_decrypt
    [ word 0x75; word 0xe8; word 0x18; word 0x8b;
      word 0xcc; word 0xe5; word 0x9a; word 0xda;
      word 0x93; word 0x9f; word 0x57; word 0xde;
      word 0x2c; word 0xb9; word 0xa4; word 0x89;eiifcbfhciurugujvrcfbnrlukjdrebhuklngddvufnf

      word 0xc3; word 0x0c; word 0xa8; word 0xf2;
      word 0xed; word 0x57 ]
    22 iv_tweak KEY1 KEY2 perror`;;
...
time (REWRITE_CONV [iv_tweak;KEY1;KEY2;perror] THENC AES256_XTS_DECRYPT_CONV)
  `aes256_xts_decrypt
    [ word 0xc3; word 0x0c; word 0xa8; word 0xf2;
      ...
      word 0xe1; word 0xc2; word 0x41 ]
    51 iv_tweak KEY1 KEY2 perror`;;

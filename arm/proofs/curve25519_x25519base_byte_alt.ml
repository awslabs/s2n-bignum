...
let LOCAL_MODINV_SAFETY_TAC (assump_name:string) (n:int) =
  REMOVE_THEN assump_name (fun safety_th ->
    ARM_SUBROUTINE_SIM_TAC ~is_safety_thm:true
      (curve25519_x25519base_byte_alt_mc',CURVE25519_X25519BASE_BYTE_ALT_EXEC,
       0x1190,
        (GEN_REWRITE_CONV RAND_CONV [bignum_inv_p25519_mc] THENC TRIM_LIST_CONV)
        `TRIM_LIST (12,16) bignum_inv_p25519_mc`,
        safety_th)
      [`e:(uarch_event)list`; `read X0 s`; `read X1 s`;
        `pc + 0x1190`; `stackpointer:int64`] n
    THENL [
      EXISTS_E2_TAC(ref
...
let full_spec,public_vars = mk_safety_spec
    ...
    (assoc "curve25519_x25519base_byte_alt" subroutine_signatures)
    CURVE25519_X25519BASE_BYTE_ALT_CORRECT
    CURVE25519_X25519BASE_BYTE_ALT_EXEC;;

let CURVE25519_X25519BASE_BYTE_ALT_SAFE = time prove
 (`exists f_events.
       forall e tables res scalar pc stackpointer.
           aligned 16 stackpointer /\
           adrp_within_bounds (word tables) (word (pc + 280)) /\
           ALL (nonoverlapping (stackpointer,448))
           [word pc,9268; word tables,48576; res,32; scalar,32] /\
           nonoverlapping (res,32) (word pc,9268)
           ==> ensures arm
               (\s.
  ...
  ENSURES_EVENTS_WHILE_UP2_TAC `63` `pc + 0x1b0` `pc + 0x1108`(*+2 insn *)
   `\i s.
      read (memory :> bytes(word tables,48576)) s =
        num_of_bytelist curve25519_x25519base_byte_alt_constant_data /\
      read SP s = stackpointer /\
  ...
  REPEAT CONJ_TAC THENL [
    ...
    ARM_STEPS_TAC CURVE25519_X25519BASE_BYTE_ALT_EXEC (6--11) THEN
    ARM_STEPS_TAC CURVE25519_X25519BASE_BYTE_ALT_EXEC (12--183) THEN
    ARM_STEPS_TAC CURVE25519_X25519BASE_BYTE_ALT_EXEC (184--211) THEN
    ARM_STEPS_TAC CURVE25519_X25519BASE_BYTE_ALT_EXEC (212--
    ...
    ARM_STEPS_TAC CURVE25519_X25519BASE_BYTE_ALT_EXEC (980--982) THEN
    ENSURES_FINAL_STATE_TAC THEN ASM_REWRITE_TAC[] THEN
    CONJ_TAC THENL [
  ...
  ENSURES_INIT_TAC "s0" THEN
  STRIP_EXISTS_ASSUM_TAC THEN
  ARM_STEPS_TAC CURVE25519_X25519BASE_BYTE_ALT_EXEC (1--2) THEN
  ARM_STEPS_TAC CURVE25519_X25519BASE_BYTE_ALT_EXEC (3--
      (2+16(*ADD_TWICE4*) + 16(*SUB_TWICE4*))) THEN
  (*ARM_STEPS_TAC CURVE25519_X25519BASE_BYTE_ALT_EXEC (35--36) THEN*)
  LOCAL_MODINV_SAFETY_TAC "H_INV_SAFE" 35 THEN
  ARM_STEPS_TAC CURVE25519_X25519BASE_BYTE_ALT_EXEC (36--(35+100)) THEN
  ARM_STEPS_TAC CURVE25519_X25519BASE_BYTE_ALT_EXEC (136--(135+62)) THEN
  ENSURES_FINAL_STATE_TAC THEN ASM_REWRITE_TAC[] THEN

  SUBST_ALL_TAC (ARITH_RULE`2 EXP 6 = 64`) THEN
  DISCHARGE_SAFETY_PROPERTY_TAC);;

let CURVE25519_X25519BASE_BYTE_ALT_SUBROUTINE_SAFE = time prove
 (`exists f_events.
               ...
               (\s.
                    ...
                    (exists e2.
                         ...
                         e2 = f_events scalar res tables pc
                            (word_sub stackpointer (word 496)) returnaddress /\
                         memaccess_inbounds e2
                            [scalar,32; res,32;
  ...
  ARM_ADD_RETURN_STACK_TAC CURVE25519_X25519BASE_BYTE_ALT_EXEC
    (REWRITE_RULE[BYTES_LOADED_DATA; fst CURVE25519_X25519BASE_BYTE_ALT_EXEC]
     CURVE25519_X25519BASE_BYTE_ALT_SAFE)

...
let BIGNUM_KSQR_32_64_NEON_LEMMA_NO_RET = prove(
  `!z x a pc.
  ...
  MP_TAC (SPECL [`z:int64`;`x:int64`;`a:num`;`pc+0x858`]
  ...
  REPEAT CONJ_TAC THENL [
    ...
    SUBGOAL_THEN
        `bignum_sqr_8_16_neon_core_mc = SUB_LIST (0x858,0xe08-0x858) bignum_ksqr_32_64_neon_mc`
        (fun th -> REWRITE_TAC[th]) THENL [
      REWRITE_TAC[bignum_sqr_8_16_neon_core_mc;bignum_ksqr_32_64_neon_mc] THEN
...
let BIGNUM_KSQR_32_64_NEON_SUBLEMMA = prove
 (`!z x a pc returnaddress.
  ...
  ARM_ADD_RETURN_NOSTACK_TAC BIGNUM_KSQR_32_64_NEON_EXEC
      BIGNUM_KSQR_32_64_NEON_LEMMA_NO_RET);;

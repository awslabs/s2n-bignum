...
(**** print_literal_from_elf "arm/sha3/sha3_keccak4_f1600_alt2.o";;
 ****)

let sha3_keccak4_f1600_alt2_mc = define_assert_from_elf
  "sha3_keccak4_f1600_alt2_mc" "arm/sha3/sha3_keccak4_f1600_alt2.o"
[
  ...
  0xf9000bfe;       (* arm_STR X30 SP (Immediate_Offset (word 16)) *)
  0x6e3c1c00;       (* arm_EOR_VEC Q0 Q0 Q28 128 *)
  0x54ffd5cd;       (* arm_BLE (word 2095800) *)
  ...
  0x17fffd25;       (* arm_B (word 268432532) *)
  0xf94003e0;       (* arm_LDR X0 SP (Immediate_Offset (word 0)) *)
  0x91096000;       (* arm_ADD X0 X0 (rvalue (word 600)) *)
  0xa9001801;       (* arm_STP X1 X6 X0 (Immediate_Offset (iword (&0))) *)
  0xa901400b;       (* arm_STP X11 X16 X0 (Immediate_Offset (iword (&16))) *)
...
let SHA3_KECCAK4_F1600_ALT2_EXEC = ARM_MK_EXEC_RULE sha3_keccak4_f1600_alt2_mc;;
...
let SHA3_KECCAK4_F1600_ALT2_CORRECT = prove
 (`!a rc A1 A2 A3 A4 pc stackpointer.
      aligned 16 stackpointer /\
      nonoverlapping (a,800) (stackpointer,216) /\
      ALLPAIRS nonoverlapping
               [(a,800); (stackpointer,216)]
               [(word pc,0xda0); (rc,192)]
      ==> ensures arm
           (\s. aligned_bytes_loaded s (word pc) sha3_keccak4_f1600_alt2_mc /\
  ...
  REWRITE_TAC[fst SHA3_KECCAK4_F1600_ALT2_EXEC] THEN
  ...
  ENSURES_WHILE_PAUP_TAC `1` `12` `pc + 0x654` `pc + 0xb9c`
   `\i s.
      (read SP s = stackpointer /\
       wordlist_from_memory(rc,24) s = round_constants /\
  ...
  REWRITE_TAC[condition_semantics] THEN REPEAT CONJ_TAC THENL
   [ARITH_TAC;
    ...
    ARM_STEPS_TAC SHA3_KECCAK4_F1600_ALT2_EXEC (1--394) THEN
    ...
    ARM_STEPS_TAC SHA3_KECCAK4_F1600_ALT2_EXEC (1--338) THEN
    ...
    CONV_TAC(ONCE_DEPTH_CONV WORDLIST_FROM_MEMORY_CONV) THEN
    CONV_TAC(ONCE_DEPTH_CONV NORMALIZE_RELATIVE_ADDRESS_CONV) THEN
    ARM_SIM_TAC SHA3_KECCAK4_F1600_ALT2_EXEC [1] THEN
  ...
  REWRITE_TAC[GSYM round_constants] THEN
  ENSURES_INIT_TAC "s0" THEN
  ARM_STEPS_TAC SHA3_KECCAK4_F1600_ALT2_EXEC (1--83) THEN
  ENSURES_FINAL_STATE_TAC THEN ASM_REWRITE_TAC[] THEN
  CONV_TAC(ONCE_DEPTH_CONV WORDLIST_FROM_MEMORY_CONV) THEN
  CONV_TAC(ONCE_DEPTH_CONV NORMALIZE_RELATIVE_ADDRESS_CONV) THEN
  ASM_REWRITE_TAC[] THEN
...
let SHA3_KECCAK4_F1600_ALT2_SUBROUTINE_CORRECT = prove
 (`!a rc A1 A2 A3 A4 pc stackpointer returnaddress.
  ...
  ARM_ADD_RETURN_STACK_TAC ~pre_post_nsteps:(11,11) SHA3_KECCAK4_F1600_ALT2_EXEC
   (CONV_RULE TWEAK_CONV SHA3_KECCAK4_F1600_ALT2_CORRECT)

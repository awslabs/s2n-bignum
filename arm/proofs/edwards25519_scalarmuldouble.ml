...
(fun w BL ADR ADRP ADD_rri64 -> [
  ...
  w 0xa9401b05;         (* arm_LDP X5 X6 X24 (Immediate_Offset (iword (&0))) *)
  ...
  w 0xa94112e3;         (* arm_LDP X3 X4 X23 (Immediate_Offset (iword (&16))) *)
  w 0xa9411b05;         (* arm_LDP X5 X6 X24 (Immediate_Offset (iword (&16))) *)
  ...
  w 0xa94112e3;         (* arm_LDP X3 X4 X23 (Immediate_Offset (iword (&16))) *)
  w 0xa94042ef;         (* arm_LDP X15 X16 X23 (Immediate_Offset (iword (&0))) *)
  w 0xeb0f0063;         (* arm_SUBS X3 X3 X15 *)
  w 0xfa100084;         (* arm_SBCS X4 X4 X16 *)
  w 0xda9f23f0;         (* arm_CSETM X16 Condition_CC *)
  w 0xa940030f;         (* arm_LDP X15 X0 X24 (Immediate_Offset (iword (&0))) *)
  ...
  w 0x910283f6;         (* arm_ADD X22 SP (rvalue (word 160)) *)
  w 0x910283f7;         (* arm_ADD X23 SP (rvalue (word 160)) *)
  w 0x94000aa1;         (* arm_BL (word 10884) *)
  w 0x910483f6;         (* arm_ADD X22 SP (rvalue (word 288)) *)
  w 0x910483f7;         (* arm_ADD X23 SP (rvalue (word 288)) *)
  w 0x910103f8;         (* arm_ADD X24 SP (rvalue (word 64)) *)
  w 0x940015b9;         (* arm_BL (word 22244) *)
  w 0x910283f6;         (* arm_ADD X22 SP (rvalue (word 160)) *)
  w 0x910283f7;         (* arm_ADD X23 SP (rvalue (word 160)) *)
  w 0x94000a9a;         (* arm_BL (word 10856) *)
  w 0x910283f6;         (* arm_ADD X22 SP (rvalue (word 160)) *)
  w 0x910283f7;         (* arm_ADD X23 SP (rvalue (word 160)) *)
  w 0x9400057e;         (* arm_BL (word 5624) *)
  w 0x910283f6;         (* arm_ADD X22 SP (rvalue (word 160)) *)
  w 0x910283f7;         (* arm_ADD X23 SP (rvalue (word 160)) *)
  w 0x910483f8;         (* arm_ADD X24 SP (rvalue (word 288)) *)
  w 0x94000f00;         (* arm_BL (word 15360) *)
  ...
  w 0xa9442eea;         (* arm_LDP X10 X11 X23 (Immediate_Offset (iword (&64))) *)
  w 0xa94536ec;         (* arm_LDP X12 X13 X23 (Immediate_Offset (iword (&80))) *)
  w 0x9baa7d42;         (* arm_UMULL X2 W10 W10 *)
  w 0xd360fd4e;         (* arm_LSR X14 X10 32 *)
  w 0x9bae7dc3;         (* arm_UMULL X3 W14 W14 *)
  w 0x9bae7d4e;         (* arm_UMULL X14 W10 W14 *)
  w 0xab0e8442;         (* arm_ADDS X2 X2 (Shiftedreg X14 LSL 33) *)
  w 0xd35ffdce;         (* arm_LSR X14 X14 31 *)
  w 0x9a0e0063;         (* arm_ADC X3 X3 X14 *)
  w 0x9bab7d64;         (* arm_UMULL X4 W11 W11 *)
  w 0xd360fd6e;         (* arm_LSR X14 X11 32 *)
  w 0x9bae7dc5;         (* arm_UMULL X5 W14 W14 *)
  w 0x9bae7d6e;         (* arm_UMULL X14 W11 W14 *)
  w 0x9b0b7d4f;         (* arm_MUL X15 X10 X11 *)
  w 0x9bcb7d50;         (* arm_UMULH X16 X10 X11 *)
  w 0xab0e8484;         (* arm_ADDS X4 X4 (Shiftedreg X14 LSL 33) *)
  w 0xd35ffdce;         (* arm_LSR X14 X14 31 *)
  w 0x9a0e00a5;         (* arm_ADC X5 X5 X14 *)
  w 0xab0f01ef;         (* arm_ADDS X15 X15 X15 *)
  w 0xba100210;         (* arm_ADCS X16 X16 X16 *)
  w 0x9a1f00a5;         (* arm_ADC X5 X5 XZR *)
  w 0xab0f0063;         (* arm_ADDS X3 X3 X15 *)
  w 0xba100084;         (* arm_ADCS X4 X4 X16 *)
  w 0x9a1f00a5;         (* arm_ADC X5 X5 XZR *)
  w 0x9bac7d86;         (* arm_UMULL X6 W12 W12 *)
  w 0xd360fd8e;         (* arm_LSR X14 X12 32 *)
  w 0x9bae7dc7;         (* arm_UMULL X7 W14 W14 *)
  w 0x9bae7d8e;         (* arm_UMULL X14 W12 W14 *)
  w 0xab0e84c6;         (* arm_ADDS X6 X6 (Shiftedreg X14 LSL 33) *)
  w 0xd35ffdce;         (* arm_LSR X14 X14 31 *)
  w 0x9a0e00e7;         (* arm_ADC X7 X7 X14 *)
  w 0x9bad7da8;         (* arm_UMULL X8 W13 W13 *)
  w 0xd360fdae;         (* arm_LSR X14 X13 32 *)
  w 0x9bae7dc9;         (* arm_UMULL X9 W14 W14 *)
  w 0x9bae7dae;         (* arm_UMULL X14 W13 W14 *)
  w 0x9b0d7d8f;         (* arm_MUL X15 X12 X13 *)
  w 0x9bcd7d90;         (* arm_UMULH X16 X12 X13 *)
  w 0xab0e8508;         (* arm_ADDS X8 X8 (Shiftedreg X14 LSL 33) *)
  w 0xd35ffdce;         (* arm_LSR X14 X14 31 *)
  w 0x9a0e0129;         (* arm_ADC X9 X9 X14 *)
  w 0xab0f01ef;         (* arm_ADDS X15 X15 X15 *)
  w 0xba100210;         (* arm_ADCS X16 X16 X16 *)
  w 0x9a1f0129;         (* arm_ADC X9 X9 XZR *)
  w 0xab0f00e7;         (* arm_ADDS X7 X7 X15 *)
  w 0xba100108;         (* arm_ADCS X8 X8 X16 *)
  w 0x9a1f0129;         (* arm_ADC X9 X9 XZR *)
  w 0xeb0c014a;         (* arm_SUBS X10 X10 X12 *)
  w 0xfa0d016b;         (* arm_SBCS X11 X11 X13 *)
  w 0xda9f23f0;         (* arm_CSETM X16 Condition_CC *)
  w 0xca10014a;         (* arm_EOR X10 X10 X16 *)
  w 0xeb10014a;         (* arm_SUBS X10 X10 X16 *)
  w 0xca10016b;         (* arm_EOR X11 X11 X16 *)
  w 0xda10016b;         (* arm_SBC X11 X11 X16 *)
  w 0xab0400c6;         (* arm_ADDS X6 X6 X4 *)
  w 0xba0500e7;         (* arm_ADCS X7 X7 X5 *)
  w 0xba1f0108;         (* arm_ADCS X8 X8 XZR *)
  w 0x9a1f0129;         (* arm_ADC X9 X9 XZR *)
  w 0x9baa7d4c;         (* arm_UMULL X12 W10 W10 *)
  w 0xd360fd45;         (* arm_LSR X5 X10 32 *)
  w 0x9ba57cad;         (* arm_UMULL X13 W5 W5 *)
  w 0x9ba57d45;         (* arm_UMULL X5 W10 W5 *)
  w 0xab05858c;         (* arm_ADDS X12 X12 (Shiftedreg X5 LSL 33) *)
  w 0xd35ffca5;         (* arm_LSR X5 X5 31 *)
  w 0x9a0501ad;         (* arm_ADC X13 X13 X5 *)
  w 0x9bab7d6f;         (* arm_UMULL X15 W11 W11 *)
  w 0xd360fd65;         (* arm_LSR X5 X11 32 *)
  w 0x9ba57cae;         (* arm_UMULL X14 W5 W5 *)
  w 0x9ba57d65;         (* arm_UMULL X5 W11 W5 *)
  w 0x9b0b7d44;         (* arm_MUL X4 X10 X11 *)
  w 0x9bcb7d50;         (* arm_UMULH X16 X10 X11 *)
  w 0xab0585ef;         (* arm_ADDS X15 X15 (Shiftedreg X5 LSL 33) *)
  w 0xd35ffca5;         (* arm_LSR X5 X5 31 *)
  w 0x9a0501ce;         (* arm_ADC X14 X14 X5 *)
  w 0xab040084;         (* arm_ADDS X4 X4 X4 *)
  w 0xba100210;         (* arm_ADCS X16 X16 X16 *)
  w 0x9a1f01ce;         (* arm_ADC X14 X14 XZR *)
  w 0xab0401ad;         (* arm_ADDS X13 X13 X4 *)
  w 0xba1001ef;         (* arm_ADCS X15 X15 X16 *)
  w 0x9a1f01ce;         (* arm_ADC X14 X14 XZR *)
  w 0xab060044;         (* arm_ADDS X4 X2 X6 *)
  w 0xba070065;         (* arm_ADCS X5 X3 X7 *)
  w 0xba0800c6;         (* arm_ADCS X6 X6 X8 *)
  w 0xba0900e7;         (* arm_ADCS X7 X7 X9 *)
  w 0xda9f23f0;         (* arm_CSETM X16 Condition_CC *)
  w 0xeb0c0084;         (* arm_SUBS X4 X4 X12 *)
  w 0xfa0d00a5;         (* arm_SBCS X5 X5 X13 *)
  w 0xfa0f00c6;         (* arm_SBCS X6 X6 X15 *)
  w 0xfa0e00e7;         (* arm_SBCS X7 X7 X14 *)
  w 0xba100108;         (* arm_ADCS X8 X8 X16 *)
  w 0x9a100129;         (* arm_ADC X9 X9 X16 *)
  w 0xd28004ca;         (* arm_MOV X10 (rvalue (word 38)) *)
  w 0x9baa7ccc;         (* arm_UMULL X12 W6 W10 *)
  w 0x8b22418c;         (* arm_ADD X12 X12 (Extendedreg W2 UXTW) *)
  w 0xd360fc42;         (* arm_LSR X2 X2 32 *)
  w 0xd360fcc6;         (* arm_LSR X6 X6 32 *)
  w 0x9baa08c6;         (* arm_UMADDL X6 W6 W10 X2 *)
  w 0xaa0c03e2;         (* arm_MOV X2 X12 *)
  w 0x9baa7cec;         (* arm_UMULL X12 W7 W10 *)
  w 0x8b23418c;         (* arm_ADD X12 X12 (Extendedreg W3 UXTW) *)
  w 0xd360fc63;         (* arm_LSR X3 X3 32 *)
  w 0xd360fce7;         (* arm_LSR X7 X7 32 *)
  w 0x9baa0ce7;         (* arm_UMADDL X7 W7 W10 X3 *)
  w 0xaa0c03e3;         (* arm_MOV X3 X12 *)
  w 0x9baa7d0c;         (* arm_UMULL X12 W8 W10 *)
  w 0x8b24418c;         (* arm_ADD X12 X12 (Extendedreg W4 UXTW) *)
  w 0xd360fc84;         (* arm_LSR X4 X4 32 *)
  w 0xd360fd08;         (* arm_LSR X8 X8 32 *)
  w 0x9baa1108;         (* arm_UMADDL X8 W8 W10 X4 *)
  w 0xaa0c03e4;         (* arm_MOV X4 X12 *)
  w 0x9baa7d2c;         (* arm_UMULL X12 W9 W10 *)
  w 0x8b25418c;         (* arm_ADD X12 X12 (Extendedreg W5 UXTW) *)
  w 0xd360fca5;         (* arm_LSR X5 X5 32 *)
  w 0xd360fd29;         (* arm_LSR X9 X9 32 *)
  w 0x9baa1529;         (* arm_UMADDL X9 W9 W10 X5 *)
  w 0xaa0c03e5;         (* arm_MOV X5 X12 *)
  w 0xd35ffd2d;         (* arm_LSR X13 X9 31 *)
  w 0xd280026b;         (* arm_MOV X11 (rvalue (word 19)) *)
  w 0x9bad7d6b;         (* arm_UMULL X11 W11 W13 *)
  w 0x8b0b0042;         (* arm_ADD X2 X2 X11 *)
  w 0xab068042;         (* arm_ADDS X2 X2 (Shiftedreg X6 LSL 32) *)
  w 0x93c680ea;         (* arm_EXTR X10 X7 X6 32 *)
  w 0xba0a0063;         (* arm_ADCS X3 X3 X10 *)
  w 0x93c7810a;         (* arm_EXTR X10 X8 X7 32 *)
  w 0xba0a0084;         (* arm_ADCS X4 X4 X10 *)
  w 0x93c8812a;         (* arm_EXTR X10 X9 X8 32 *)
  w 0xd34101ab;         (* arm_LSL X11 X13 63 *)
  w 0xca0b00a5;         (* arm_EOR X5 X5 X11 *)
  w 0x9a0a00a5;         (* arm_ADC X5 X5 X10 *)
  w 0xa9020fe2;         (* arm_STP X2 X3 SP (Immediate_Offset (iword (&32))) *)
  w 0xa90317e4;         (* arm_STP X4 X5 SP (Immediate_Offset (iword (&48))) *)
  w 0xa9402eea;         (* arm_LDP X10 X11 X23 (Immediate_Offset (iword (&0))) *)
  w 0xa94136ec;         (* arm_LDP X12 X13 X23 (Immediate_Offset (iword (&16))) *)
  w 0x9baa7d42;         (* arm_UMULL X2 W10 W10 *)
  w 0xd360fd4e;         (* arm_LSR X14 X10 32 *)
  w 0x9bae7dc3;         (* arm_UMULL X3 W14 W14 *)
  w 0x9bae7d4e;         (* arm_UMULL X14 W10 W14 *)
  ...
  w 0xca0b00a5;         (* arm_EOR X5 X5 X11 *)
  w 0x9a0a00a5;         (* arm_ADC X5 X5 X10 *)
  w 0xa9040fe2;         (* arm_STP X2 X3 SP (Immediate_Offset (iword (&64))) *)
  w 0xa90517e4;         (* arm_STP X4 X5 SP (Immediate_Offset (iword (&80))) *)
  w 0xa9422eea;         (* arm_LDP X10 X11 X23 (Immediate_Offset (iword (&32))) *)
  w 0xa94336ec;         (* arm_LDP X12 X13 X23 (Immediate_Offset (iword (&48))) *)
  w 0x9baa7d42;         (* arm_UMULL X2 W10 W10 *)
  w 0xd360fd4e;         (* arm_LSR X14 X10 32 *)
  w 0x9bae7dc3;         (* arm_UMULL X3 W14 W14 *)
  w 0x9bae7d4e;         (* arm_UMULL X14 W10 W14 *)
  ...
  w 0xca0b00a5;         (* arm_EOR X5 X5 X11 *)
  w 0x9a0a00a5;         (* arm_ADC X5 X5 X10 *)
  w 0xa9060fe2;         (* arm_STP X2 X3 SP (Immediate_Offset (iword (&96))) *)
  w 0xa90717e4;         (* arm_STP X4 X5 SP (Immediate_Offset (iword (&112))) *)
  ...
  w 0xa9402fea;         (* arm_LDP X10 X11 SP (Immediate_Offset (iword (&0))) *)
  w 0xa94137ec;         (* arm_LDP X12 X13 SP (Immediate_Offset (iword (&16))) *)
  w 0x9baa7d42;         (* arm_UMULL X2 W10 W10 *)
  w 0xd360fd4e;         (* arm_LSR X14 X10 32 *)
  w 0x9bae7dc3;         (* arm_UMULL X3 W14 W14 *)
  w 0x9bae7d4e;         (* arm_UMULL X14 W10 W14 *)
  ...
  w 0xca0b00a5;         (* arm_EOR X5 X5 X11 *)
  w 0x9a0a00a5;         (* arm_ADC X5 X5 X10 *)
  w 0xa9000fe2;         (* arm_STP X2 X3 SP (Immediate_Offset (iword (&0))) *)
  w 0xa90117e4;         (* arm_STP X4 X5 SP (Immediate_Offset (iword (&16))) *)
  ...
  w 0xba090069;         (* arm_ADCS X9 X3 X9 *)
  w 0x9a10014a;         (* arm_ADC X10 X10 X16 *)
  w 0xa94513e3;         (* arm_LDP X3 X4 SP (Immediate_Offset (iword (&80))) *)
  ...
  w 0x9a1001ce;         (* arm_ADC X14 X14 X16 *)
  w 0xa94513e3;         (* arm_LDP X3 X4 SP (Immediate_Offset (iword (&80))) *)
  w 0xa94443ef;         (* arm_LDP X15 X16 SP (Immediate_Offset (iword (&64))) *)
  w 0xeb0f0063;         (* arm_SUBS X3 X3 X15 *)
  w 0xfa100084;         (* arm_SBCS X4 X4 X16 *)
  w 0xda9f23f0;         (* arm_CSETM X16 Condition_CC *)
  w 0xa94803ef;         (* arm_LDP X15 X0 SP (Immediate_Offset (iword (&128))) *)
  w 0xeb0501e5;         (* arm_SUBS X5 X15 X5 *)
  w 0xfa060006;         (* arm_SBCS X6 X0 X6 *)
  w 0xda9f23e0;         (* arm_CSETM X0 Condition_CC *)
  w 0xca100063;         (* arm_EOR X3 X3 X16 *)
  ...
  w 0xca05014a;         (* arm_EOR X10 X10 X5 *)
  w 0x9a03014a;         (* arm_ADC X10 X10 X3 *)
  w 0xa90222c7;         (* arm_STP X7 X8 X22 (Immediate_Offset (iword (&32))) *)
  w 0xa9032ac9;         (* arm_STP X9 X10 X22 (Immediate_Offset (iword (&48))) *)
  ...
  w 0xba090069;         (* arm_ADCS X9 X3 X9 *)
  w 0x9a10014a;         (* arm_ADC X10 X10 X16 *)
  w 0xa94713e3;         (* arm_LDP X3 X4 SP (Immediate_Offset (iword (&112))) *)
  w 0xa9451be5;         (* arm_LDP X5 X6 SP (Immediate_Offset (iword (&80))) *)
  w 0x9ba57c6b;         (* arm_UMULL X11 W3 W5 *)
  w 0xd360fc60;         (* arm_LSR X0 X3 32 *)
  w 0x9ba57c0f;         (* arm_UMULL X15 W0 W5 *)
  ...
  w 0x9a1001ce;         (* arm_ADC X14 X14 X16 *)
  w 0xa94713e3;         (* arm_LDP X3 X4 SP (Immediate_Offset (iword (&112))) *)
  w 0xa94643ef;         (* arm_LDP X15 X16 SP (Immediate_Offset (iword (&96))) *)
  w 0xeb0f0063;         (* arm_SUBS X3 X3 X15 *)
  w 0xfa100084;         (* arm_SBCS X4 X4 X16 *)
  w 0xda9f23f0;         (* arm_CSETM X16 Condition_CC *)
  ...
  w 0xca05014a;         (* arm_EOR X10 X10 X5 *)
  w 0x9a03014a;         (* arm_ADC X10 X10 X3 *)
  w 0xa90422c7;         (* arm_STP X7 X8 X22 (Immediate_Offset (iword (&64))) *)
  w 0xa9052ac9;         (* arm_STP X9 X10 X22 (Immediate_Offset (iword (&80))) *)
  w 0xa94213e3;         (* arm_LDP X3 X4 SP (Immediate_Offset (iword (&32))) *)
  w 0xa9481be5;         (* arm_LDP X5 X6 SP (Immediate_Offset (iword (&128))) *)
  w 0x9ba57c67;         (* arm_UMULL X7 W3 W5 *)
  w 0xd360fc60;         (* arm_LSR X0 X3 32 *)
  ...
  w 0xba090069;         (* arm_ADCS X9 X3 X9 *)
  w 0x9a10014a;         (* arm_ADC X10 X10 X16 *)
  w 0xa94313e3;         (* arm_LDP X3 X4 SP (Immediate_Offset (iword (&48))) *)
  w 0xa9491be5;         (* arm_LDP X5 X6 SP (Immediate_Offset (iword (&144))) *)
  w 0x9ba57c6b;         (* arm_UMULL X11 W3 W5 *)
  w 0xd360fc60;         (* arm_LSR X0 X3 32 *)
  w 0x9ba57c0f;         (* arm_UMULL X15 W0 W5 *)
  ...
  w 0x9a1001ce;         (* arm_ADC X14 X14 X16 *)
  w 0xa94313e3;         (* arm_LDP X3 X4 SP (Immediate_Offset (iword (&48))) *)
  w 0xa94243ef;         (* arm_LDP X15 X16 SP (Immediate_Offset (iword (&32))) *)
  w 0xeb0f0063;         (* arm_SUBS X3 X3 X15 *)
  w 0xfa100084;         (* arm_SBCS X4 X4 X16 *)
  w 0xda9f23f0;         (* arm_CSETM X16 Condition_CC *)
  w 0xa94803ef;         (* arm_LDP X15 X0 SP (Immediate_Offset (iword (&128))) *)
  ...
  w 0xca05014a;         (* arm_EOR X10 X10 X5 *)
  w 0x9a03014a;         (* arm_ADC X10 X10 X3 *)
  w 0xa90622c7;         (* arm_STP X7 X8 X22 (Immediate_Offset (iword (&96))) *)
  w 0xa9072ac9;         (* arm_STP X9 X10 X22 (Immediate_Offset (iword (&112))) *)
  w 0xa94213e3;         (* arm_LDP X3 X4 SP (Immediate_Offset (iword (&32))) *)
  ...
  w 0xa9461b05;         (* arm_LDP X5 X6 X24 (Immediate_Offset (iword (&96))) *)
  w 0x9ba57c67;         (* arm_UMULL X7 W3 W5 *)
  w 0xd360fc60;         (* arm_LSR X0 X3 32 *)
  w 0x9ba57c0f;         (* arm_UMULL X15 W0 W5 *)
  w 0xd360fcb0;         (* arm_LSR X16 X5 32 *)
  ...
  w 0xba090069;         (* arm_ADCS X9 X3 X9 *)
  w 0x9a10014a;         (* arm_ADC X10 X10 X16 *)
  w 0xa94712e3;         (* arm_LDP X3 X4 X23 (Immediate_Offset (iword (&112))) *)
  w 0xa9471b05;         (* arm_LDP X5 X6 X24 (Immediate_Offset (iword (&112))) *)
  w 0x9ba57c6b;         (* arm_UMULL X11 W3 W5 *)
  w 0xd360fc60;         (* arm_LSR X0 X3 32 *)
  w 0x9ba57c0f;         (* arm_UMULL X15 W0 W5 *)
  w 0xd360fcb0;         (* arm_LSR X16 X5 32 *)
  ...
  w 0x9a1001ce;         (* arm_ADC X14 X14 X16 *)
  w 0xa94712e3;         (* arm_LDP X3 X4 X23 (Immediate_Offset (iword (&112))) *)
  w 0xa94642ef;         (* arm_LDP X15 X16 X23 (Immediate_Offset (iword (&96))) *)
  w 0xeb0f0063;         (* arm_SUBS X3 X3 X15 *)
  w 0xfa100084;         (* arm_SBCS X4 X4 X16 *)
  w 0xda9f23f0;         (* arm_CSETM X16 Condition_CC *)
  w 0xa946030f;         (* arm_LDP X15 X0 X24 (Immediate_Offset (iword (&96))) *)
  w 0xeb0501e5;         (* arm_SUBS X5 X15 X5 *)
  w 0xfa060006;         (* arm_SBCS X6 X0 X6 *)
  w 0xda9f23e0;         (* arm_CSETM X0 Condition_CC *)
  w 0xca100063;         (* arm_EOR X3 X3 X16 *)
  ...
  w 0xca05014a;         (* arm_EOR X10 X10 X5 *)
  w 0x9a03014a;         (* arm_ADC X10 X10 X3 *)
  w 0xa90023e7;         (* arm_STP X7 X8 SP (Immediate_Offset (iword (&0))) *)
  w 0xa9012be9;         (* arm_STP X9 X10 SP (Immediate_Offset (iword (&16))) *)
  ...
  w 0xca05014a;         (* arm_EOR X10 X10 X5 *)
  w 0x9a03014a;         (* arm_ADC X10 X10 X3 *)
  w 0xa90223e7;         (* arm_STP X7 X8 SP (Immediate_Offset (iword (&32))) *)
  w 0xa9032be9;         (* arm_STP X9 X10 SP (Immediate_Offset (iword (&48))) *)
  w 0xa94613e3;         (* arm_LDP X3 X4 SP (Immediate_Offset (iword (&96))) *)
  w 0xa9481be5;         (* arm_LDP X5 X6 SP (Immediate_Offset (iword (&128))) *)
  w 0x9ba57c67;         (* arm_UMULL X7 W3 W5 *)
  w 0xd360fc60;         (* arm_LSR X0 X3 32 *)
  ...
  w 0xca05014a;         (* arm_EOR X10 X10 X5 *)
  w 0x9a03014a;         (* arm_ADC X10 X10 X3 *)
  w 0xa90623e7;         (* arm_STP X7 X8 SP (Immediate_Offset (iword (&96))) *)
  w 0xa9072be9;         (* arm_STP X9 X10 SP (Immediate_Offset (iword (&112))) *)
  ...
  w 0xfa100084;         (* arm_SBCS X4 X4 X16 *)
  w 0xda9f23f0;         (* arm_CSETM X16 Condition_CC *)
  w 0xa94003ef;         (* arm_LDP X15 X0 SP (Immediate_Offset (iword (&0))) *)
  w 0xeb0501e5;         (* arm_SUBS X5 X15 X5 *)
  w 0xfa060006;         (* arm_SBCS X6 X0 X6 *)
  w 0xda9f23e0;         (* arm_CSETM X0 Condition_CC *)
  w 0xca100063;         (* arm_EOR X3 X3 X16 *)
  ...
  w 0xca05014a;         (* arm_EOR X10 X10 X5 *)
  w 0x9a03014a;         (* arm_ADC X10 X10 X3 *)
  w 0xa90423e7;         (* arm_STP X7 X8 SP (Immediate_Offset (iword (&64))) *)
  w 0xa9052be9;         (* arm_STP X9 X10 SP (Immediate_Offset (iword (&80))) *)
  ...
  w 0xba090069;         (* arm_ADCS X9 X3 X9 *)
  w 0x9a10014a;         (* arm_ADC X10 X10 X16 *)
  w 0xa94512e3;         (* arm_LDP X3 X4 X23 (Immediate_Offset (iword (&80))) *)
  ...
  w 0x9a1001ce;         (* arm_ADC X14 X14 X16 *)
  w 0xa94512e3;         (* arm_LDP X3 X4 X23 (Immediate_Offset (iword (&80))) *)
  w 0xa94442ef;         (* arm_LDP X15 X16 X23 (Immediate_Offset (iword (&64))) *)
  w 0xeb0f0063;         (* arm_SUBS X3 X3 X15 *)
  w 0xfa100084;         (* arm_SBCS X4 X4 X16 *)
  w 0xda9f23f0;         (* arm_CSETM X16 Condition_CC *)
  w 0xa94a03ef;         (* arm_LDP X15 X0 SP (Immediate_Offset (iword (&160))) *)
  w 0xeb0501e5;         (* arm_SUBS X5 X15 X5 *)
  w 0xfa060006;         (* arm_SBCS X6 X0 X6 *)
  w 0xda9f23e0;         (* arm_CSETM X0 Condition_CC *)
  w 0xca100063;         (* arm_EOR X3 X3 X16 *)
  ...
  w 0xba090069;         (* arm_ADCS X9 X3 X9 *)
  w 0x9a10014a;         (* arm_ADC X10 X10 X16 *)
  w 0xa94113e3;         (* arm_LDP X3 X4 SP (Immediate_Offset (iword (&16))) *)
  w 0xa94b1be5;         (* arm_LDP X5 X6 SP (Immediate_Offset (iword (&176))) *)
  w 0x9ba57c6b;         (* arm_UMULL X11 W3 W5 *)
  w 0xd360fc60;         (* arm_LSR X0 X3 32 *)
  w 0x9ba57c0f;         (* arm_UMULL X15 W0 W5 *)
  ...
  w 0x9a1001ce;         (* arm_ADC X14 X14 X16 *)
  w 0xa94113e3;         (* arm_LDP X3 X4 SP (Immediate_Offset (iword (&16))) *)
  w 0xa94043ef;         (* arm_LDP X15 X16 SP (Immediate_Offset (iword (&0))) *)
  w 0xeb0f0063;         (* arm_SUBS X3 X3 X15 *)
  w 0xfa100084;         (* arm_SBCS X4 X4 X16 *)
  w 0xda9f23f0;         (* arm_CSETM X16 Condition_CC *)
  w 0xa94a03ef;         (* arm_LDP X15 X0 SP (Immediate_Offset (iword (&160))) *)
  ...
  w 0xa94612e3;         (* arm_LDP X3 X4 X23 (Immediate_Offset (iword (&96))) *)
  w 0xa9441b05;         (* arm_LDP X5 X6 X24 (Immediate_Offset (iword (&64))) *)
  w 0x9ba57c67;         (* arm_UMULL X7 W3 W5 *)
  w 0xd360fc60;         (* arm_LSR X0 X3 32 *)
  w 0x9ba57c0f;         (* arm_UMULL X15 W0 W5 *)
  w 0xd360fcb0;         (* arm_LSR X16 X5 32 *)
  ...
  w 0xfa100084;         (* arm_SBCS X4 X4 X16 *)
  w 0xda9f23f0;         (* arm_CSETM X16 Condition_CC *)
  w 0xa944030f;         (* arm_LDP X15 X0 X24 (Immediate_Offset (iword (&64))) *)
  w 0xeb0501e5;         (* arm_SUBS X5 X15 X5 *)
  w 0xfa060006;         (* arm_SBCS X6 X0 X6 *)
  w 0xda9f23e0;         (* arm_CSETM X0 Condition_CC *)
  w 0xca100063;         (* arm_EOR X3 X3 X16 *)
  ...
  w 0xfa100084;         (* arm_SBCS X4 X4 X16 *)
  w 0xda9f23f0;         (* arm_CSETM X16 Condition_CC *)
  w 0xa942030f;         (* arm_LDP X15 X0 X24 (Immediate_Offset (iword (&32))) *)
  w 0xeb0501e5;         (* arm_SUBS X5 X15 X5 *)
  w 0xfa060006;         (* arm_SBCS X6 X0 X6 *)
  w 0xda9f23e0;         (* arm_CSETM X0 Condition_CC *)
  w 0xca100063;         (* arm_EOR X3 X3 X16 *)
...
let BYTES_LOADED_DATA = prove
 (`bytes_loaded s tab edwards25519_scalarmuldouble_constant_data <=>
   read (memory :> bytes(tab,768)) s =
   num_of_bytelist edwards25519_scalarmuldouble_constant_data`,
  REWRITE_TAC[bytes_loaded; READ_BYTELIST_EQ_BYTES;
    CONV_RULE (RAND_CONV LENGTH_CONV)
     (AP_TERM `LENGTH:byte list->num` edwards25519_scalarmuldouble_constant_data)]);;

let EDWARDS25519DOUBLEBASE_TABLE_LEMMA = prove
 (`read (memory :> bytes(wpc,768)) s =
   num_of_bytelist edwards25519_scalarmuldouble_constant_data
   ==> !i. i < 8
           ==> edwards25519_epprojective
                (group_pow edwards25519_group E_25519 (i + 1))
         (bignum_from_memory(word_add wpc (word (96 * i)),4) s,
          bignum_from_memory(word_add wpc (word (96 * i + 32)),4) s,
          bignum_from_memory(word_add wpc (word (96 * i + 64)),4) s) /\
         ~(bignum_from_memory(word_add wpc (word (96 * i + 64)),4) s =
           0)`,
  let GE25519_POWERS =
    end_itlist CONJ
    (funpow 7 (fun l -> GE25519_GROUPER GE25519_POW_1 (hd l)::l)
                          [GE25519_POW_1]) in
  REWRITE_TAC[GSYM BYTES_LOADED_DATA; edwards25519_scalarmuldouble_constant_data] THEN
...
let edwards25519_scalarmuldouble_mc' =
  SPECL [`pc:num`; `tables:num`] edwards25519_scalarmuldouble_mc;;
...
let LOCAL_MUL_P25519_TAC =
  ARM_MACRO_SIM_ABBREV_TAC edwards25519_scalarmuldouble_mc' 180 lvs
   `!(t:armstate) pcin pcout p3 n3 p1 n1 p2 n2.
      ...
      nonoverlapping (word pc,0x7da8) (word_add (read p3 t) (word n3),8 * 4)
      ==> ensures arm
           (\s. aligned_bytes_loaded s (word pc) (edwards25519_scalarmuldouble_mc pc tables) /\
                read PC s = pcin /\
                read SP s = read SP t /\
...
let LOCAL_MODINV_TAC =
  ARM_SUBROUTINE_SIM_TAC
   (edwards25519_scalarmuldouble_mc',
    EDWARDS25519_SCALARMULDOUBLE_EXEC,0x1268,
   ...
   [`read X0 s`; `read X1 s`;
    ...
    `pc + 0x1268`; `word_add stackpointer (word 192):int64`];;
...
let LOCAL_EPADD_CORRECT = time prove
 (`!p3 p1 Q1 p2 Q2 pc stackpointer.
    ...
    ALL (nonoverlapping (stackpointer,192))
        [(word pc,0x7da8); (p3,128); (p1,128); (p2,128)] /\
    nonoverlapping (p3,128) (word pc,0x7da8)
    ==> ensures arm
         (\s. aligned_bytes_loaded s (word pc)
                 (edwards25519_scalarmuldouble_mc pc tables) /\
...
let LOCAL_PEPADD_CORRECT = time prove
 (`!p3 p1 Q1 p2 T2 pc stackpointer.
    aligned 16 stackpointer /\
    ALL (nonoverlapping (stackpointer,192))
        [(word pc,0x7da8); (p3,128); (p1,128); (p2,96)] /\
    nonoverlapping (p3,128) (word pc,0x7da8)
    ==> ensures arm
         (\s. aligned_bytes_loaded s (word pc)
                 (edwards25519_scalarmuldouble_mc pc tables) /\
...
let EDWARDS25519_SCALARMULDOUBLE_CORRECT = time prove
 (`!tables res scalar point bscalar n xy m pc stackpointer.
    ...
    ALL (nonoverlapping (stackpointer,1632))
        [(word pc,0x7da8); (word tables,768);
         (res,64); (scalar,32); (point,64); (bscalar,32)] /\
    nonoverlapping (res,64) (word pc,0x7da8)
    ==> ensures arm
         (\s. aligned_bytes_loaded s (word pc)
                (edwards25519_scalarmuldouble_mc pc tables) /\
  ...
  ENSURES_WHILE_DOWN_TAC `63` `pc + 0xacc` `pc + 0x125c`
   `\i s.
  ...
  REPEAT CONJ_TAC THENL
   [ARITH_TAC;
    ...
    ARM_STEPS_TAC EDWARDS25519_SCALARMULDOUBLE_EXEC (124--128) THEN
    ...
    ARM_STEPS_TAC EDWARDS25519_SCALARMULDOUBLE_EXEC (129--305) THEN
    MAP_EVERY ABBREV_TAC
    ...
    ARM_STEPS_TAC EDWARDS25519_SCALARMULDOUBLE_EXEC (306--308) THEN
    ...
    CLARIFY_TAC THEN
    ARM_STEPS_TAC EDWARDS25519_SCALARMULDOUBLE_EXEC (309--539) THEN
    MAP_EVERY ABBREV_TAC
    ...
    ARM_STEPS_TAC EDWARDS25519_SCALARMULDOUBLE_EXEC (540--544) THEN
    LOCAL_PEPADD_TAC 545 THEN
    ARM_STEPS_TAC EDWARDS25519_SCALARMULDOUBLE_EXEC (546--547) THEN
    ENSURES_FINAL_STATE_TAC THEN ASM_REWRITE_TAC[] THEN
  ...
  ARM_STEPS_TAC EDWARDS25519_SCALARMULDOUBLE_EXEC (9--18) THEN
  ...
  ARM_STEPS_TAC EDWARDS25519_SCALARMULDOUBLE_EXEC (19--189) THEN
  ...
  ARM_ACCSTEPS_TAC EDWARDS25519_SCALARMULDOUBLE_EXEC (205--208) (190--214) THEN
  MAP_EVERY ABBREV_TAC
  ...
  ARM_STEPS_TAC EDWARDS25519_SCALARMULDOUBLE_EXEC (215--222) THEN
  ...
  CLARIFY_TAC THEN
  ARM_STEPS_TAC EDWARDS25519_SCALARMULDOUBLE_EXEC (223--445) THEN
  MAP_EVERY REABBREV_TAC
   [`fab0 = read X0 s445`;
    `fab1 = read X1 s445`;
    `fab2 = read X2 s445`;
  ...
  ARM_STEPS_TAC EDWARDS25519_SCALARMULDOUBLE_EXEC (472--475) THEN
  ...
  ARM_STEPS_TAC EDWARDS25519_SCALARMULDOUBLE_EXEC (477--478) THEN

  (*** Addition of precomputed and fresh table entries ***)

  ARM_STEPS_TAC EDWARDS25519_SCALARMULDOUBLE_EXEC (479--483) THEN
  ...
  ARM_STEPS_TAC EDWARDS25519_SCALARMULDOUBLE_EXEC (485--486) THEN

  (*** Doubling to acc' = 8 * acc ***)

  ARM_STEPS_TAC EDWARDS25519_SCALARMULDOUBLE_EXEC (487--490) THEN
  ...
  ARM_STEPS_TAC EDWARDS25519_SCALARMULDOUBLE_EXEC (492--493) THEN

  (*** Doubling to acc' = 16 * acc ***)

  ARM_STEPS_TAC EDWARDS25519_SCALARMULDOUBLE_EXEC (494--497) THEN
  ...
  ARM_STEPS_TAC EDWARDS25519_SCALARMULDOUBLE_EXEC (499--500) THEN

  (*** The final addition acc' = 16 * acc + tables ***)

  ARM_STEPS_TAC EDWARDS25519_SCALARMULDOUBLE_EXEC (501--505) THEN
  ...
  ARM_STEPS_TAC EDWARDS25519_SCALARMULDOUBLE_EXEC (507--508) THEN
...
let EDWARDS25519_SCALARMULDOUBLE_SUBROUTINE_CORRECT = time prove
 (`!tables res scalar point bscalar n xy m pc stackpointer returnaddress.
  ...
  REWRITE_TAC[BYTES_LOADED_DATA; fst EDWARDS25519_SCALARMULDOUBLE_EXEC] THEN
  ARM_ADD_RETURN_STACK_TAC EDWARDS25519_SCALARMULDOUBLE_EXEC
   (REWRITE_RULE[BYTES_LOADED_DATA; fst EDWARDS25519_SCALARMULDOUBLE_EXEC]
  ...
  REMOVE_THEN assump_name (fun safety_th ->
    ARM_SUBROUTINE_SIM_TAC ~is_safety_thm:true
        ...
        [`e:(uarch_event)list`; `read X0 s`; `read X1 s`;
          `pc + 0x1268`; `word_add stackpointer (word 192):int64`] n
    THENL [
      EXISTS_E2_TAC(ref
...
let LOCAL_EPDOUBLE_SAFE = time prove
 (`exists f_events. forall e p3 p1 pc tables stackpointer.
    aligned 16 stackpointer /\
    ALL (nonoverlapping (stackpointer,160))
        [(word pc,0x7da8); (p3,128); (p1,96)] /\
    nonoverlapping (p3,128) (word pc,0x7da8)
    ==> ensures arm
         ...
         (\s. read PC s = word (pc + 0x3c9c) /\
          ...
          (MAYCHANGE [PC; X0; X1; X2; X3; X4; X5; X6; X7; X8; X9; X10;
           ...
           MAYCHANGE [memory :> bytes(p3,128);
                      memory :> bytes(stackpointer,160)])`,
  PROVE_SAFETY_SPEC_TAC EDWARDS25519_SCALARMULDOUBLE_EXEC);;

let LOCAL_EPDOUBLE_SAFETY_TAC (assump_name:string) (n:int) =
  REMOVE_THEN assump_name (fun safety_th ->
    ARM_SUBROUTINE_SIM_TAC ~is_safety_thm:true
        (edwards25519_scalarmuldouble_mc',EDWARDS25519_SCALARMULDOUBLE_EXEC,
          0x0,edwards25519_scalarmuldouble_mc',safety_th)
        [`e:(uarch_event)list`; `read X22 s`; `read X23 s`;
        `pc:num`; `tables:num`; `read SP s`] n
    THENL [
      EXISTS_E2_TAC(ref
        [`scalar:int64`;`point:int64`;`res:int64`;`pc:num`;`bscalar:int64`;
         `stackpointer:int64`;`tables:num`;
...
let LOCAL_PDOUBLE_SAFE = time prove
 (`exists f_events. forall e p3 p1 pc tables stackpointer.
    aligned 16 stackpointer /\
    ALL (nonoverlapping (stackpointer,160))
        [(word pc,0x7da8); (p3,96); (p1,96)] /\
    ...
    ==> ensures arm
         ...
         (\s. read PC s = word (pc + 0x4e50) /\
              (exists e2.
                  ...
                  e2 = f_events p1 p3 pc stackpointer /\
                  memaccess_inbounds e2
                    [p3,96; p1,96; stackpointer,160]
                    [p3,96; stackpointer,160]))
          (MAYCHANGE [PC; X0; X1; X2; X3; X4; X5; X6; X7; X8; X9; X10;
                      X11; X12; X13; X14; X15; X16] ,,
           MAYCHANGE SOME_FLAGS ,, MAYCHANGE [events] ,,
           MAYCHANGE [memory :> bytes(p3,96);
...
let LOCAL_PDOUBLE_SAFETY_TAC (assump_name:string) (n:int) =
  REMOVE_THEN assump_name (fun safety_th ->
    ARM_SUBROUTINE_SIM_TAC ~is_safety_thm:true
        (edwards25519_scalarmuldouble_mc',EDWARDS25519_SCALARMULDOUBLE_EXEC,
          0x0,edwards25519_scalarmuldouble_mc',safety_th)
...
let LOCAL_EPADD_SAFE = time prove
 (`exists f_events. forall e p3 p1 p2 pc tables stackpointer.
    aligned 16 stackpointer /\
    ALL (nonoverlapping (stackpointer,192))
        [(word pc,0x7da8); (p3,128); (p1,128); (p2,128)] /\
    nonoverlapping (p3,128) (word pc,0x7da8)
    ==> ensures arm
         ...
         (\s. read PC s = word (pc + 0x690c) /\
              (exists e2.
                  ...
                  memaccess_inbounds e2
                    [p3,128; p1,128; p2,128; stackpointer,192]
...
let LOCAL_EPADD_SAFETY_TAC (assump_name:string) (n:int) =
  REMOVE_THEN assump_name (fun safety_th ->
    ARM_SUBROUTINE_SIM_TAC ~is_safety_thm:true
        (edwards25519_scalarmuldouble_mc',EDWARDS25519_SCALARMULDOUBLE_EXEC,
          0x0,edwards25519_scalarmuldouble_mc',safety_th)
        [`e:(uarch_event)list`; `read X22 s`; `read X23 s`;
        `read X24 s`;
        `pc:num`;  `tables:num`;`read SP s`] n THENL [
      EXISTS_E2_TAC(ref
        [`scalar:int64`;`point:int64`;`res:int64`;`pc:num`;`bscalar:int64`;
         `stackpointer:int64`;`tables:num`;
         (* inside the loop... *)
...
let LOCAL_PEPADD_SAFE = time prove
 (`exists f_events. forall e p3 p1 p2 pc tables stackpointer.
    aligned 16 stackpointer /\
    ALL (nonoverlapping (stackpointer,192))
        [(word pc,0x7da8); (p3,128); (p1,128); (p2,96)] /\
    ...
    ==> ensures arm
         ...
         (\s. read PC s = word (pc + 0x7da0) /\
              (exists e2.
                  ...
                  e2 = f_events p1 p2 p3 pc stackpointer /\
                  memaccess_inbounds e2
                    [p3,128; p1,128; p2,96; stackpointer,192]
                    [p3,128; stackpointer,192]))
          (MAYCHANGE [PC; X0; X1; X2; X3; X4; X5; X6; X7; X8; X9; X10;
                      X11; X12; X13; X14; X15; X16] ,,
           MAYCHANGE SOME_FLAGS ,, MAYCHANGE [events] ,,
...
let LOCAL_PEPADD_SAFETY_TAC (assump_name:string) (n:int) =
  REMOVE_THEN assump_name (fun safety_th ->
    ARM_SUBROUTINE_SIM_TAC ~is_safety_thm:true
        (edwards25519_scalarmuldouble_mc',EDWARDS25519_SCALARMULDOUBLE_EXEC,
          0x0,edwards25519_scalarmuldouble_mc',safety_th)
...
let full_spec,public_vars = mk_safety_spec
    ...
    (assoc "edwards25519_scalarmuldouble" subroutine_signatures)
    EDWARDS25519_SCALARMULDOUBLE_CORRECT
    EDWARDS25519_SCALARMULDOUBLE_EXEC;;

let EDWARDS25519_SCALARMULDOUBLE_SAFE = time prove
 (`exists f_events.
       forall e tables res scalar point bscalar pc stackpointer.
           aligned 16 stackpointer /\
           adrp_within_bounds (word tables) (word (pc + 1096)) /\
           adrp_within_bounds (word tables) (word (pc + 2812)) /\
           ALL (nonoverlapping (stackpointer,1632))
           [word pc,32168; word tables,768; res,64; scalar,32; point,64;
            bscalar,32] /\
           nonoverlapping (res,64) (word pc,32168)
           ==> ensures arm
               (\s.
                    ...
                    read events s = e)
               (\s.
                    read PC s = word (pc + 10280) /\
                    (exists e2.
                         read events s = APPEND e2 e /\
                         e2 =
                         f_events scalar point bscalar res tables pc
                            stackpointer /\
                         memaccess_inbounds e2
                          [scalar,32; point,64; bscalar,32; res,64;
                            stackpointer,1632; word tables,768]
                          [res,64; stackpointer,1632]))
               (MAYCHANGE
  ...
  ASSUME_CALLEE_SAFETY_TAILED_TAC LOCAL_EPDOUBLE_SAFE "H_EPDOUBLE" THEN
  ASSUME_CALLEE_SAFETY_TAILED_TAC LOCAL_PDOUBLE_SAFE "H_PDOUBLE" THEN
  ASSUME_CALLEE_SAFETY_TAILED_TAC LOCAL_EPADD_SAFE "H_EPADD" THEN
  ASSUME_CALLEE_SAFETY_TAILED_TAC LOCAL_PEPADD_SAFE "H_PEPADD" THEN

  CONCRETIZE_F_EVENTS_TAC
    `\(scalar:int64) (point:int64) (bscalar:int64) (res:int64) (tables:num)
      (pc:num) (stackpointer:int64).
      APPEND
        (f_ev_epil scalar point bscalar res tables pc stackpointer)
        (APPEND
          (ENUMERATEL 63 (\i.
            f_ev_loop scalar point bscalar res tables pc stackpointer i))
          (f_ev_prol scalar point bscalar res tables pc stackpointer))
  ...
  ENSURES_EVENTS_WHILE_UP2_TAC `63` `pc + 0xacc` `pc + 0x1260`(*+1 insn *)
   `\i s.
      read (memory :> bytes (word tables,768)) s =
        num_of_bytelist edwards25519_scalarmuldouble_constant_data /\
      read SP s = word_add stackpointer (word 192) /\
      read X25 s = res /\
      read X19 s = word (4 * (63 - i))` THEN
  REPEAT CONJ_TAC THENL [
    ARITH_TAC;

    ENSURES_INIT_TAC "s0" THEN
    ARM_STEPS_TAC EDWARDS25519_SCALARMULDOUBLE_EXEC (1--64) THEN
    ARM_STEPS_TAC EDWARDS25519_SCALARMULDOUBLE_EXEC (65--(64+6+172(*MUL_4*))) THEN
    (* following the step numbers of fn correctness... *)
    ARM_STEPS_TAC EDWARDS25519_SCALARMULDOUBLE_EXEC (72--75) THEN
    LOCAL_EPDOUBLE_SAFETY_TAC "H_EPDOUBLE" 76 THEN
    ARM_STEPS_TAC EDWARDS25519_SCALARMULDOUBLE_EXEC (77--83) THEN
    LOCAL_EPADD_SAFETY_TAC "H_EPADD" 84 THEN
    ARM_STEPS_TAC EDWARDS25519_SCALARMULDOUBLE_EXEC (85--90) THEN
    LOCAL_EPDOUBLE_SAFETY_TAC "H_EPDOUBLE" 91 THEN
    ARM_STEPS_TAC EDWARDS25519_SCALARMULDOUBLE_EXEC (92--98) THEN
    LOCAL_EPADD_SAFETY_TAC "H_EPADD" 99 THEN
    ARM_STEPS_TAC EDWARDS25519_SCALARMULDOUBLE_EXEC (100--105) THEN
    LOCAL_EPDOUBLE_SAFETY_TAC "H_EPDOUBLE" 106 THEN
    ARM_STEPS_TAC EDWARDS25519_SCALARMULDOUBLE_EXEC (107--113) THEN
    LOCAL_EPADD_SAFETY_TAC "H_EPADD" 114 THEN
    ARM_STEPS_TAC EDWARDS25519_SCALARMULDOUBLE_EXEC (115--120) THEN
    LOCAL_EPDOUBLE_SAFETY_TAC "H_EPDOUBLE" 121 THEN
    ARM_STEPS_TAC EDWARDS25519_SCALARMULDOUBLE_EXEC (122--128) THEN
    REPEAT(FIRST_X_ASSUM(SUBST_ALL_TAC o MATCH_MP ADRP_ADD_FOLD)) THEN
    ARM_STEPS_TAC EDWARDS25519_SCALARMULDOUBLE_EXEC (129--539) THEN
    ARM_STEPS_TAC EDWARDS25519_SCALARMULDOUBLE_EXEC (540--544) THEN
    LOCAL_PEPADD_SAFETY_TAC "H_PEPADD" 545 THEN
    ARM_STEPS_TAC EDWARDS25519_SCALARMULDOUBLE_EXEC (546--547) THEN
    ENSURES_FINAL_STATE_TAC THEN ASM_REWRITE_TAC[] THEN
    ...
    ARM_STEPS_TAC EDWARDS25519_SCALARMULDOUBLE_EXEC (1--2) THEN
    LOCAL_MODINV_SAFETY_TAC "H_INV" 3 THEN
    ARM_STEPS_TAC EDWARDS25519_SCALARMULDOUBLE_EXEC (4--(3+3+180(*MUL_P25519*))) THEN
    ARM_STEPS_TAC EDWARDS25519_SCALARMULDOUBLE_EXEC (5--(4+3+180(*MUL_P25519*))) THEN
    ENSURES_FINAL_STATE_TAC THEN ASM_REWRITE_TAC[] THEN
  ...
  ENSURES_INIT_TAC "s0" THEN STRIP_EXISTS_ASSUM_TAC THEN
  ARM_STEPS_TAC EDWARDS25519_SCALARMULDOUBLE_EXEC (1--5) THEN
  LOCAL_PDOUBLE_SAFETY_TAC "H_PDOUBLE" 6 THEN
  ARM_STEPS_TAC EDWARDS25519_SCALARMULDOUBLE_EXEC (7--8) THEN
  ARM_STEPS_TAC EDWARDS25519_SCALARMULDOUBLE_EXEC (9--18) THEN
  REPEAT(FIRST_X_ASSUM(SUBST_ALL_TAC o MATCH_MP ADRP_ADD_FOLD)) THEN
  ARM_STEPS_TAC EDWARDS25519_SCALARMULDOUBLE_EXEC (19--189) THEN
  ARM_STEPS_TAC EDWARDS25519_SCALARMULDOUBLE_EXEC (190--214) THEN
  ARM_STEPS_TAC EDWARDS25519_SCALARMULDOUBLE_EXEC (215--222) THEN
  ARM_STEPS_TAC EDWARDS25519_SCALARMULDOUBLE_EXEC (223--445) THEN
  ARM_STEPS_TAC EDWARDS25519_SCALARMULDOUBLE_EXEC (446--471) THEN
  ARM_STEPS_TAC EDWARDS25519_SCALARMULDOUBLE_EXEC (472--475) THEN
  LOCAL_PDOUBLE_SAFETY_TAC "H_PDOUBLE" 476 THEN
  ARM_STEPS_TAC EDWARDS25519_SCALARMULDOUBLE_EXEC (477--478) THEN
  ARM_STEPS_TAC EDWARDS25519_SCALARMULDOUBLE_EXEC (479--483) THEN
  LOCAL_PEPADD_SAFETY_TAC "H_PEPADD" 484 THEN
  ARM_STEPS_TAC EDWARDS25519_SCALARMULDOUBLE_EXEC (485--486) THEN
  ARM_STEPS_TAC EDWARDS25519_SCALARMULDOUBLE_EXEC (487--490) THEN
  LOCAL_PDOUBLE_SAFETY_TAC "H_PDOUBLE" 491 THEN
  ARM_STEPS_TAC EDWARDS25519_SCALARMULDOUBLE_EXEC (492--493) THEN
  ARM_STEPS_TAC EDWARDS25519_SCALARMULDOUBLE_EXEC (494--497) THEN
  LOCAL_EPDOUBLE_SAFETY_TAC "H_EPDOUBLE" 498 THEN
  ARM_STEPS_TAC EDWARDS25519_SCALARMULDOUBLE_EXEC (499--500) THEN
  ARM_STEPS_TAC EDWARDS25519_SCALARMULDOUBLE_EXEC (501--505) THEN
  LOCAL_EPADD_SAFETY_TAC "H_EPADD" 506 THEN
  ARM_STEPS_TAC EDWARDS25519_SCALARMULDOUBLE_EXEC (507--508) THEN
  ARM_STEPS_TAC EDWARDS25519_SCALARMULDOUBLE_EXEC (509--509) THEN
  ENSURES_FINAL_STATE_TAC THEN ASM_REWRITE_TAC[] THEN
  CONJ_TAC THENL [
    REWRITE_TAC[VAL_WORD_SUB_EQ_0] THEN
    MAP_EVERY VAL_INT64_TAC [`4 * (63 - i)`; `4`] THEN
    ASM_REWRITE_TAC[] THEN
  ...
  SUBGOAL_THEN
    `val (word_ushr (word_sub (word (4 * (63 - i))) (word 4):int64) 6) =
     (4 * (63 - (i + 1))) DIV 64` SUBST_ALL_TAC THENL [
    REWRITE_TAC[VAL_WORD_USHR] THEN
    IMP_REWRITE_TAC[WORD_SUB2; VAL_WORD;MOD_LT;DIMINDEX_64] THEN
    REPEAT CONJ_TAC THEN SIMPLE_ARITH_TAC;
    ALL_TAC
  ] THEN
  DISCHARGE_SAFETY_PROPERTY_TAC);;
...
let full_subr_spec,public_vars = mk_safety_spec
    ...
    ~keep_maychanges:true
    (assoc "edwards25519_scalarmuldouble" subroutine_signatures)
    EDWARDS25519_SCALARMULDOUBLE_SUBROUTINE_CORRECT
    EDWARDS25519_SCALARMULDOUBLE_EXEC;;

let EDWARDS25519_SCALARMULDOUBLE_SUBROUTINE_SAFE = time prove
 (`exists f_events.
          ...
          ==> ensures arm
               ...
               (\s.
                    ...
                    (exists e2.
                         ...
                         e2 =
                         f_events scalar point bscalar res tables pc
                            (word_sub stackpointer (word 1696)) returnaddress /\
                         memaccess_inbounds e2
                          [scalar,32; point,64; bscalar,32; res,64;
                            word_sub stackpointer (word 1696),1696;
                            word tables,768]
                          [res,64;
                            word_sub stackpointer (word 1696),1696]))
               (MAYCHANGE_REGS_AND_FLAGS_PERMITTED_BY_ABI ,,
  ...
  ARM_ADD_RETURN_STACK_TAC EDWARDS25519_SCALARMULDOUBLE_EXEC
   (REWRITE_RULE[BYTES_LOADED_DATA; fst EDWARDS25519_SCALARMULDOUBLE_EXEC]
    EDWARDS25519_SCALARMULDOUBLE_SAFE)
   `[X19; X20; X21; X22; X23; X24; X25; X30]` 1696 THEN
  DISCHARGE_SAFETY_PROPERTY_TAC);;
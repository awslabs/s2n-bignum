...
(* + GHASH_6BLOCK_AS_NBLOCK + GHASH_POLYVAL_ACC_6 + POLYVAL_DOT_H6_EQ.       *)
(* ========================================================================= *)
...
let GHASH_6BLOCK_KARATSUBA_EQ_POLYVAL_ACC = prove
 (`!(b1:int128) (b2:int128) (b3:int128) (b4:int128) (b5:int128) (b6:int128) (h:int128)
  ...
  SUBGOAL_THEN
    `[(b1:int128, word_swaphalves128 (polyval_dot (polyval_dot (polyval_dot (polyval_dot h h) (polyval_dot h h)) h) h):int128, h6k:int128);
      (b2:int128, word_swaphalves128 (polyval_dot (polyval_dot (polyval_dot h h) (polyval_dot h h)) h):int128, h5k:int128);
      (b3:int128, word_swaphalves128 (polyval_dot (polyval_dot h h) (polyval_dot h h)):int128, h4k:int128);
      (b4:int128, word_swaphalves128 (polyval_dot h (polyval_dot h h)):int128, h3k:int128);
      (b5:int128, word_swaphalves128 (polyval_dot h h):int128, h2k:int128);
      (b6:int128, word_swaphalves128 h:int128, hk:int128)] =
     project_triples
       [(b1, word_swaphalves128 (polyval_dot (polyval_dot (polyval_dot (polyval_dot h h) (polyval_dot h h)) h) h), h6k, (polyval_dot (polyval_dot (polyval_dot (polyval_dot h h) (polyval_dot h h)) h) h));
        (b2, word_swaphalves128 (polyval_dot (polyval_dot (polyval_dot h h) (polyval_dot h h)) h), h5k, (polyval_dot (polyval_dot (polyval_dot h h) (polyval_dot h h)) h));
        (b3, word_swaphalves128 (polyval_dot (polyval_dot h h) (polyval_dot h h)), h4k, (polyval_dot (polyval_dot h h) (polyval_dot h h)));
        (b4, word_swaphalves128 (polyval_dot h (polyval_dot h h)), h3k, (polyval_dot h (polyval_dot h h)));
        (b5, word_swaphalves128 (polyval_dot h h), h2k, (polyval_dot h h));
        (b6, word_swaphalves128 h, hk, h)]`
    SUBST1_TAC THENL [REWRITE_TAC[project_triples]; ALL_TAC] THEN
  MP_TAC(SPEC
    `[(b1:int128, word_swaphalves128 (polyval_dot (polyval_dot (polyval_dot (polyval_dot h h) (polyval_dot h h)) h) h):int128, h6k:int128, (polyval_dot (polyval_dot (polyval_dot (polyval_dot h h) (polyval_dot h h)) h) h):int128);
      (b2:int128, word_swaphalves128 (polyval_dot (polyval_dot (polyval_dot h h) (polyval_dot h h)) h):int128, h5k:int128, (polyval_dot (polyval_dot (polyval_dot h h) (polyval_dot h h)) h):int128);
      (b3:int128, word_swaphalves128 (polyval_dot (polyval_dot h h) (polyval_dot h h)):int128, h4k:int128, (polyval_dot (polyval_dot h h) (polyval_dot h h)):int128);
      (b4:int128, word_swaphalves128 (polyval_dot h (polyval_dot h h)):int128, h3k:int128, (polyval_dot h (polyval_dot h h)):int128);
      (b5:int128, word_swaphalves128 (polyval_dot h h):int128, h2k:int128, (polyval_dot h h):int128);
      (b6:int128, word_swaphalves128 h:int128, hk:int128, h:int128)]
...
(* GHASH_POLYVAL_ACC_6 and the symmetric h-power normalizers POLYVAL_DOT_H4..H6_EQ
...
(* ===== Partial-final-block helpers (total bytes = 80 + byte_len) ========= *)

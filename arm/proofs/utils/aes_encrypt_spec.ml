 ...
 *)
(* ====================================================================================== *)
(* AES-256 encryption spec https://nvlpubs.nist.gov/nistpubs/FIPS/NIST.FIPS.197-upd1.pdf. *)
(* ====================================================================================== *)
needs "common/aes.ml";;
...
time prove (`aes256_encrypt
    ...
    CONV_TAC(LAND_CONV (REWRITE_CONV [ROUND_KEYS] THENC AESENC_HELPER_CONV)) THEN REFL_TAC);;
*)

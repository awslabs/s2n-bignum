...
let BIGNUM_KMUL_16_32_NEON_LEMMA_NO_RET = prove(
 `!z x y a b pc.
  ...
  MP_TAC (SPECL [`z:int64`;`x:int64`;`y:int64`;`a:num`;`b:num`;`pc+0x3bc`]
  ...
  REPEAT CONJ_TAC THENL [
    ...
    SUBGOAL_THEN
        `bignum_mul_8_16_neon_core_mc = SUB_LIST (0x3bc,0xb70-0x3bc)  
            bignum_kmul_16_32_neon_mc`
        (fun th -> REWRITE_TAC[th]) THENL [
      REWRITE_TAC[bignum_mul_8_16_neon_core_mc;bignum_kmul_16_32_neon_mc] THEN
...
let BIGNUM_KMUL_16_32_NEON_LEMMA = prove
 (`!z x y a b pc returnaddress.
  ...
  ARM_ADD_RETURN_NOSTACK_TAC BIGNUM_KMUL_16_32_NEON_EXEC
    BIGNUM_KMUL_16_32_NEON_LEMMA_NO_RET);;

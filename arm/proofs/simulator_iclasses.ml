...
let check_insns () =
  ...
  let skipping_iclasses = [
    ...
    (*** ld1 (1 register, Post-register offset) 128-bit ***)
    "01001100110xxxxx0111xxxxxxxxxxxx";

    (*** st1 (1 register, Post-register offset) 128-bit ***)
    "01001100100xxxxx0111xxxxxxxxxxxx";

    (*** ld1 (1 register, no Post-immediate offset) 128-bit ***)
    "01001100010000000111xxxxxxxxxxxx";

    (*** st1 (1 register, no Post-immediate offset) 128-bit ***)
    "01001100100111110111xxxxxxxxxxxx";
